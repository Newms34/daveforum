...
"use strict";!function(){const e=io(),t=angular.module("brethren-app",["ui.router","ngAnimate","ngSanitize","ngMessages","chart.js"]),a=angular.module("reset-app",[]),o=[{t:"<",s:"&lt;"},{t:">",s:"&gt;"},{t:"[&amp;D[w+/]+=*]",s:"<build-template build='$&'></build-template>;"}],n=new showdown.Converter,r="data:image/png;base64,";Array.prototype.findUser=function(e){for(let t=0;t<this.length;t++)if(this[t].user==e)return t;return-1};t.constant("imgTypes",["apng","bmp","gif","ico","cur","jpg","jpeg","jfif","pjpeg","pjp","png","svg","tif","tiff","webp"]),t.constant("vidTypes",["mp4","avi","mpg","webm","ogg","flv"]),t.constant("defBlg",{title:"No blog yet!",media:{url:"https://media.giphy.com/media/9J7tdYltWyXIY/giphy.mp4",type:"mp4"},txtHtml:"\n    <p class='is-italic'>Just looking for the regular [PAIN] website? Click Sign up/Login up above!</p><br>\n    <p>Welcome to Brethren[Pain]!<br>\n    Moderators: This platform supports a format known as Markdown. Some basic formatting tricks:</p>\n    <table class=\"table table-striped table-bordered\">\n    <thead>\n    <tr>\n    <th><strong>Code</strong></th>\n    <th><strong>Action</strong></th>\n    <th><strong>Example/Notes</strong></th>\n    </tr>\n    </thead>\n    <tbody>\n    <tr>\n    <td>*text*</td>\n    <td>Italic</td>\n    <td>This text is <em>very</em> italic!</td>\n    </tr>\n    <tr>\n    <td>**text**</td>\n    <td>Bold</td>\n    <td>This text <strong>isn’t</strong> scared of you!</td>\n    </tr>\n    <tr>\n    <td># text</td>\n    <td>Heading</td>\n    <td>Makes text bigger. The more '#'s there are, the <em>smaller</em> the text will be! Needs to be on its own line.</td>\n    </tr>\n    <tr>\n    <td>- Text</td>\n    <td>Bullet point</td>\n    <td>Make sure to put an empty line right before this</td>\n    </tr>\n    <tr>\n    <td>1.Text</td>\n    <td>Numbered list</td>\n    <td>Exactly what it says on the box</td>\n    </tr>\n    <tr>\n    <td>[Link](address)</td>\n    <td>Link</td>\n    <td><a href=\"https://www.google.com\">Head over to google</a></td>\n    </tr>\n    <tr>\n    <td>![Image](SomeImageAddress)</td>\n    <td>Image</td>\n    <td>Displays an image. The text between the []s is shown when you hover over the image.</td>\n    </tr>\n    </tbody>\n    </table>\n    <p>You can also include optional media (a youtube video, a picture, etc.) using the provided fields</p>",txtMd:"Welcome to Brethren[Pain]!\n    Moderators: This platform supports a format known as Markdown. Some basic formatting tricks:\n    |**Code**|**Action**|**Example/Notes**|\n    |---|---|---|\n    |*text*|Italic| This text is *very* italic!|\n    |**text**|Bold|This text **isn't** scared of you!|\n    |# text|Heading|Makes text bigger. The more '#'s there are, the *smaller* the text will be! Needs to be on its own line.|\n    | - Text| Bullet point| Make sure to put an empty line right before this|\n    | 1.Text| Numbered list|Exactly what it says on the box|\n    |[Link](address)|Link|[Head over to google](https://www.google.com)|\n    |![Image](SomeImageAddress)|Image|Displays an image. The text between the []s is shown when you hover over the image.|\n    You can also include optional media (a youtube video, a picture, etc.) using the provided fields"}),t.config(["$stateProvider","$urlRouterProvider","$locationProvider","$httpProvider","$sceDelegateProvider",function(e,t,a,o,n){a.html5Mode(!0),n.resourceUrlWhitelist(["self","https://www.youtube.com/**"]),t.otherwise("/404"),e.state("app",{abstract:!0,templateUrl:"layouts/full.html"}).state("app.dash",{url:"/dash",templateUrl:"components/dash.html"}).state("app.chat",{url:"/chat",templateUrl:"components/chat.html"}).state("app.calendar",{url:"/calendar",templateUrl:"components/calendar.html"}).state("app.help",{url:"/help",templateUrl:"components/help/help.html"}).state("app.blog",{url:"/blog",templateUrl:"components/blog.html"}).state("app.forum",{url:"/forum",templateUrl:"components/forums/forum.html"}).state("app.forumCat",{url:"/forumCat?c",templateUrl:"components/forums/forumCat.html"}).state("app.forumThr",{url:"/forumThr?c&t",templateUrl:"components/forums/forumThr.html"}).state("app.tools",{url:"/tools",templateUrl:"components/tools.html"}).state("appSimp",{abstract:!0,templateUrl:"components/layout/simp.html"}).state("appSimp.home",{url:"/",templateUrl:"components/home.html"}).state("appSimp.login",{url:"/login",templateUrl:"components/login.html"}).state("appSimp.register",{url:"/register",templateUrl:"components/register.html"}).state("appSimp.unconfirmed",{url:"/unconf",templateUrl:"components/alt/unconfirmed.html"}).state("appSimp.notfound",{url:"/404",templateUrl:"components/alt/404.html"}).state("appSimp.err",{url:"/500",templateUrl:"components/alt/500.html"})}]).directive("fileread",[function(){return{scope:{fileread:"="},link:function(e,t,a){t.bind("change",(function(t){const a=new FileReader,o=t.target.files[0],n=o.name;return console.log("UPLOADING FILE",o),a.onload=function(t){let a=t.target.result;console.log("URI before optional resize",a,a.length),e.$parent.needsResize?s(e,a,e.$parent.needsResize,e.$parent.needsResize,n):(console.log("APPLYING file to $parent"),e.$apply((function(){e.$parent&&e.$parent.$parent&&e.$parent.$parent.avas?(e.$parent.$parent.loadingFile=!1,e.$parent.$parent.fileName="Loaded:"+n,e.$parent.$parent.fileread=a):(e.$parent.loadingFile=!1,e.$parent.fileName="Loaded:"+n,e.$parent.fileread=a),e.$parent.saveDataURI&&"function"==typeof e.$parent.saveDataURI&&e.$parent.saveDataURI(dataURI)})))},o?o.size>25e5?(bulmabox.alert("File too Large",`Your file ${o.name} is larger than 2.5MB. Please upload a smaller file!`),!1):void a.readAsDataURL(o):(e.$apply((function(){e.fileread="",e.$parent.fileName=!1,e.$parent.loadingFile=!1})),!1)}))}}}]).directive("buildTemplate",["$rootScope","$log",function(e,t){return{scope:{build:"@"},template:"<div class='build-code' title='Inspect this build'>{{build}}</div>",replace:!0,restrict:"E",link:function(e,t,a){let o=e;for(;o.$parent&&!o.label;)console.log("Not yet found base! current:",o,o.label,"has parent?",o.$parent),o=o.$parent;console.log("final base",o.label),t.bind("click",(function(e){o.inspectCode(a.build)}))}}}]).directive("bindHtmlCompile",["$compile",function(e){return{restrict:"A",link:function(t,a,o){t.$watch((function(){return t.$eval(o.bindHtmlCompile)}),(function(o){a.html(o),e(a.contents())(t)}))}}}]),Array.prototype.rotate=function(e){let t=angular.copy(this);for(let a=0;a<e;a++)t.push(t.shift());return t},Date.prototype.dyMo=function(){return this.getMonth()+1+"/"+this.getDate()},String.prototype.titleCase=function(){return this.split(/\s/).map(e=>e.slice(0,1).toUpperCase()+e.slice(1).toLowerCase()).join(" ")},Object.prototype.copy=function(){return JSON.parse(JSON.stringify(this))};const s=(e,t,a,o,n)=>{const r=document.createElement("img");r.onload=function(){const t=document.createElement("canvas"),r=t.getContext("2d");t.width=a,t.height=o,r.drawImage(this,0,0,a,o);const s=t.toDataURL();e.$apply((function(){e.$parent.loadingFile=!1,e.$parent.fileName="Loaded:"+n,e.fileread=s,e.$parent.saveDataURI&&"function"==typeof e.$parent.saveDataURI&&e.$parent.saveDataURI(s)}))},r.src=t};String.prototype.sanAndParse=function(){let e=this;for(rp of o)console.log("replacing",rp.t,"with",rp.s),e=e.replace(new RegExp(rp.t,"g"),rp.s);return e.replace(/\[c=["']?[\w#\s,\(\)]{2,}['"]?\][^\[]*\[\/c\]/,(function(e){console.log("at beginning of col replace, m is",e);const t=e.match(/(?<=\[c=['"]?)[\w#\s\(\)]{2,}(?=['"]?\])/)&&e.match(/(?<=\[c=['"]?)[\w#\s\(\)]{2,}(?=['"]?\])/)[0],a=e.match(/(?<=\])[^\[]{2,}(?=\[\/c\])/)&&e.match(/(?<=\])[^\[]{2,}(?=\[\/c\])/)[0];return console.log("M",e,"COLOR CODE",t,"TEXT",a),`<span style='color:${t}'>${a}</span>`}))},String.prototype.md2h=function(e){return e?n.makeHtml(this).slice(3,-4):n.makeHtml(this)},showdown.setOption("tables",!0),t.controller("all-cont",["$scope","$http","$sce","$log",(t,a,o,n)=>{t.label="allBase",t.currBuild={},t.inspectCode=e=>{a.get("/tool/build?build="+encodeURIComponent(e.replace("&amp;","&"))).then(e=>{t.currBuild.data=e.data,t.currBuild.whichSkill=0})},t.noBuild=e=>{t.currBuild.data=null},t.copyCode=e=>{n.debug("attempting to copy",e),prompt("Press ctrl-c (cmd-c on Mac) to copy this code!",e.parentNode.querySelector(".build-code").innerText)},t.infoBox={x:0,y:0,data:null},t.skillBox={x:0,y:0,on:!1,data:{}},t.explTrait=(e,a,o)=>{t.infoBox.x=a.screenX,t.infoBox.y=a.screenY-50,t.infoBox.data=e?`<div class='is-fullwidth ${e.picked||o?"has-text-white":"has-text-grey"}'>\n            <div class='is-fullwidth is-size-5 has-text-centered'>${e.name}</div>\n            <p>${e.desc}</p>\n            </div>`:null},t.explSkill=(e,a,o)=>{if(t.skillBox.x=a.screenX,t.skillBox.y=a.screenY-50,e){t.skillBox.data=e;const a=t.currBuild.data.specs.map(e=>e.usedTraits).flat();t.skillBox.data.realFacts=e.facts.map((t,o)=>{const r=e.traited_facts&&e.traited_facts.find(e=>e.overrides==o);return r&&a.includes(r.requires_trait)&&(t={...JSON.parse(JSON.stringify(t)),...r,isTraited:!0},n.debug("FOUND replacement fact",r,"FOR SKILL",e.name,"REQUIRED TRAIT",r.requires_trait,"SKILL NOW",t)),t}),n.debug("SKILL INFO",e,"CURR BUILD",t.currBuild.data,"USED TRAITS",a),t.skillBox.on=!0}else t.skillBox.on=!1},t.tryReconnect=()=>{a.get("/alive").then(e=>{bulmabox.confirm('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Server Restarted',"There's been an update, and we need to reload the website to restore functionality.<br/>Click Okay to reload, or Cancel to stay on this page.",(function(e){e&&window.location.reload()}))}).catch(e=>{setTimeout((function(){t.tryReconnect()}),500)})},e.on("disconnect",(function(e){t.tryReconnect(),n.debug("disconnected!",e)}))}]),Date.prototype.stdTimezoneOffset=function(){var e=new Date(this.getFullYear(),0,1),t=new Date(this.getFullYear(),6,1);return Math.max(e.getTimezoneOffset(),t.getTimezoneOffset())},Date.prototype.isDstObserved=function(){return this.getTimezoneOffset()<this.stdTimezoneOffset()},t.controller("cal-cont",["$scope","$http","$state",function(t,a,o){t.cal=[],t.days=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],t.calLoaded=!1,t.wkOpts=[{lbl:"Every week",n:1},{lbl:"Every two weeks",n:2},{lbl:"Every three weeks",n:3},{lbl:"Every four weeks",n:4},{lbl:"Every five weeks",n:5}],a.get("/user/usrData").then(e=>{t.user=e.data}),t.refCal=()=>{a.get("/cal/all").then(e=>{console.log("calendar events response:",e),t.makeCalendar(e.data)})},e.on("refCal",e=>{t.refCal()}),t.refCal(),t.makeCalendar=e=>{t.offsetDays=t.days.rotate((new Date).getDay());let a=0,o=0,n=new Date;for(n.setHours(0,0,0,0),n=n.getTime(),t.cal=[];a<6;a++){let r={wk:a,wkSt:new Date(n+7*a*1e3*3600*24),wkEn:new Date(n+1e3*(7*(a+1)-1)*3600*24),days:[]};for(o=0;o<7;o++){let t=new Date(n+1e3*(7*a+o)*3600*24);r.days.push({d:o,evts:e.filter(e=>{let a=new Date(e.eventDate).getTime();return console.log("THIS DATE DTNUM",a,t.getTime()),a>t.getTime()&&a<t.getTime()+864e5}),date:t})}t.cal.push(r)}console.log("CAL STUFF",t.cal,t.offsetDays)},t.viewEvent=e=>{console.log("View event",e);let a=null;e.paid&&e.paid.length&&(a=`<ul class='ul'>\n                ${e.paid.map(e=>"<li> - "+e+"</li>").join("")}\n            </ul>`),bulmabox.alert(`Event: ${e.title}`,`Time:${new Date(e.eventDate).toLocaleString()}<br>Type:${t.kindOpts.find(t=>t.kind==e.kind).kindLong}<br>${a?"Paid Users<br>"+a:""}<hr> Description: ${e.text}`)},t.editEventObj={title:"",desc:"",day:0,time:2*((new Date).getHours()+((new Date).getMinutes()<30?.5:0)),kind:"lotto",id:null},t.clearEdit=()=>{t.editEventAct=!1},t.editEventAct=!1,t.editEvent=e=>{t.editEventAct=!0,console.log("Edit event",e,"hour options",t.hourOpts);const a=new Date(e.eventDate).setHours(0,0,0,0),o=Date.now();t.editEventObj={title:e.title,desc:e.text,kind:t.kindOpts.find(t=>t.kind==e.kind),time:Math.floor((e.eventDate-a)/18e5),day:Math.round((e.eventDate-o)/864e5),id:e._id,user:e.user}},t.doEdit=()=>{console.log("Input edit event",t.editEventObj);const e=new Date;let o=t.editEventObj.day,n=t.editEventObj.time;(new Date).isDstObserved()||(n+=2)>47&&(n%=47,o++),e.setHours(0,0,0,0);let r=e.getTime()+1800*n*1e3+3600*o*1e3*24;if(console.log("Sending event",t.editEventObj,r),r<Date.now()+3e5)return bulmabox.alert("Time Expiring",`Your selected time, ${new Date(r).toLocaleString()}, occurs too soon! Please select a later time.`),!1;a.post("/cal/edit",{title:t.editEventObj.title,text:t.editEventObj.desc,eventDate:r,kind:t.editEventObj.kind.kind,id:t.editEventObj.id,user:t.editEventObj.user}).then((function(e){console.log("edit event response",e),"wrongUser"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle"></i> Wrong User',"You cannot edit this event, as you are not its creator and are not a moderator."),t.refCal(),t.clearEdit()}))},t.delEvent=e=>{console.log("Delete event",e),bulmabox.confirm("Delete Event",`Are you sure you wish to delete the following event?<br> Title: ${e.title}<br>Description: ${e.text}`,(function(o){if(!o||null==o)return!1;a.get("/cal/del?id="+e._id).then((function(e){console.log("delete response",e),t.refCal()}))}))},t.addEvent=!1,t.newEventObj={title:"",desc:"",day:0,time:2*((new Date).getHours()+((new Date).getMinutes()<30?.5:0)),kind:"lotto",repeatNum:1,repeatOn:!1,repeatFreq:1},a.get("/user/allUsrs").then(e=>{t.allUsrs=e.data.map(e=>e.user)}),t.addPaid=e=>{const o=t.allUsrs.filter(t=>!e.paid||!e.paid.length||e.paid.indexOf(t)<0).map(e=>`<option value='${e}'>${e}</option>`).join("");bulmabox.custom("Add Paid User",`Select a user from the list below to add them to this lotto's candidates:<br><p class='select'><select id='payusr'>${o}</select></p>`,(function(){let t=document.querySelector("#payusr").value;console.log("User wishes to add",t),a.post("/cal/lottoPay",{lottoId:e._id,pusr:t})}))},t.hourOpts=new Array(48).fill(100).map((e,t)=>{let a=t<24?"AM":"PM",o=Math.floor(t/2)<13?Math.floor(t/2):Math.floor(t/2)-12;return o<1&&(o=12),{num:t,hr:o+(t%2?":30":":00")+a}}),t.dayOpts=new Array(42).fill(100).map((e,t)=>{let a=new Date(Date.now()+3600*t*1e3*24);return{num:t,day:a.getMonth()+1+"/"+a.getDate()}}),t.kindOpts=[{kind:"lotto",desc:"An item or items will be given away by a [PAIN] member to one lucky guild member!",kindLong:"Lottery/Giveaway"},{kind:"payLotto",desc:"Try your luck! One lucky winner will win the pool of donations!",kindLong:"Paid Lottery/Giveaway"},{kind:"announce",desc:"Someone needs to make an important announcement!",kindLong:"Announcement"},{kind:"contest",desc:"Some sort of contest! See who's the best!",kindLong:"Contest"},{kind:"other",desc:"Any other event type",kindLong:"Other"}],t.doAdd=()=>{const e=new Date;let o=t.newEventObj.time,n=t.newEventObj.day;e.setHours(0,0,0,0),(new Date).isDstObserved()||(o+=2)>47&&(o%=47,n++);let r=e.getTime()+1800*o*1e3+3600*n*1e3*24,s=t.newEventObj.repeatOn?"/cal/newRep":"/cal/new";if(r<Date.now()+3e5)return bulmabox.alert("Time Expiring",`Your selected time, ${new Date(r).toLocaleString()}, occurs too soon! Please select a later time.`),!1;console.log("Sending event",t.newEventObj,r),a.post(s,{title:t.newEventObj.title,text:t.newEventObj.desc,eventDate:r,kind:t.newEventObj.kind.kind,repeatNum:t.newEventObj.repeatNum,repeatFreq:t.newEventObj.repeatFreq,repeatOn:t.newEventObj.repeatOn}).then((function(e){console.log("new event response",e),t.refCal(),t.clearAdd()}))},t.clearAdd=()=>{t.addEvent=!1,t.newEventObj={title:"",desc:"",day:0,time:2*((new Date).getHours()+((new Date).getMinutes()<30?.5:0)),kind:"lotto",repeatNum:1,repeatFreq:1,repeatOn:!1}}}]),t.controller("chat-cont",["$scope","$http","$state","$filter","$sce",function(t,a,o,n,r){a.get("/user/getUsr").then(e=>{t.doUser(e.data),console.log("user",t.user)}),t.msgs=[],t.doUser=e=>{if(!e)return!1;t.user=e,t.msgs.push({time:Date.now(),user:"System",msg:"Welcome to Brethren [PAIN] Chat! You're logged in as "+e.user+". Try /wiki or /google to search for stuff!",isSys:!0})},t.parseMsg=e=>0===e.indexOf("/wiki ")?`Wiki: <a href="https://wiki.guildwars2.com/wiki/${e.slice(6)}" target="_blank">${e.slice(6)}</a>`:0===e.indexOf("/google ")?`Google: <a href="https://www.google.com/search?q=${e.slice(8)}" target="_blank">${e.slice(8)}</a>`:e,a.get("/user/allUsrs").then(e=>{console.log("all users is",e),t.allUsers=e.data}),e.on("msgOut",(function(e){console.log("raw msg",e),e.msg=r.trustAsHtml(t.parseMsg(e.msg)),t.msgs.push(e),t.msgs.length>100&&t.msgs.shift(),t.$apply(),document.querySelector("#chat-container").scrollTop=document.querySelector("#chat-container").scrollHeight})),e.on("disconnect",(function(){t.msgs.push({time:Date.now(),user:"System",msg:"Warning: The connection to the server was lost. Until you refresh, chat's probably gonna be pretty quiet!",isSys:!0}),t.msgs.length>100&&t.msgs.shift(),t.$apply(),document.querySelector("#chat-container").scrollTop=document.querySelector("#chat-container").scrollHeight})),e.on("allNames",e=>(e.user==t.user.user&&(e.msg=r.trustAsHtml(`Users online: ${e.names.join(", ")}`),e.isSys=!0,t.msgs.push(e),t.msgs.length>100&&t.msgs.shift(),t.$apply(),document.querySelector("#chat-container").scrollTop=document.querySelector("#chat-container").scrollHeight),!1)),t.sendChat=()=>{if(!t.newMsg)return!1;"/list"==t.newMsg.toLowerCase()?e.emit("getOnline",{u:t.user.user}):(t.newMsg.toLowerCase().startsWith("/disc")&&e.emit("toDiscord",{u:t.user.user,msg:t.newMsg.replace("/disc","")}),e.emit("chatMsg",{user:t.user.user,msg:t.newMsg.sanAndParse().md2h(!0)})),t.newMsg=""}}]),t.controller("dash-cont",["$scope","$http","$state","$filter",function(t,a,o,n){t.showDups=localStorage.brethDups,a.get("/user/usrData").then(e=>{t.doUser(e.data),console.log("user",t.user)}),t.setAccount=()=>{a.put("/user/accountName?account="+t.user.account).then(e=>{bulmabox.alert("Account Name Saved","Thanks! We&rsquo;ve saved your account name!"),a.get("/user/usrData").then(e=>{t.doUser(e.data)})})},a.get("/cal/latestFive").then(e=>{t.latestEvents=e.data}),t.doUser=e=>{if(!e)return!1;t.user=e,console.log(e),t.possibleInterests.forEach((t,a)=>{e.ints&&e.ints[a]&&1==e.ints[a]&&(t.active=!0)}),t.numUnreadMsgs=e.msgs.filter(e=>!e.read).length},t.setPwd=e=>{bulmabox.confirm("Reset Password",`Are you sure you wish to create a temporary, one-time-use password for ${e.user}?`,t=>{t&&a.get("/user/setPasswordMod?user="+e.user).then(t=>{console.log("user",e.user,"pwd set to",t.data),bulmabox.alert("User password reset",`User ${e.user}'s password has been set to: <br><pre>${t.data.pwd}</pre><hr/> Note that this is a one-time use password!`)})})},e.on("sentMsg",(function(e){console.log("SOCKET USER",e,"this user",t.user),e.user!=t.user.user&&e.from!=t.user.user||(console.log("re-getting user"),a.get("/user/usrData").then(e=>{t.doUser(e.data)}))})),t.tabs=[{name:"Profile/Characters",icon:"user"},{name:"Members",icon:"users"},{name:"Mail",icon:"envelope"},{name:"Upcoming Events",icon:"calendar"}],t.defaultPic=r,t.loadingFile=!1,t.fileName=null,t.needsResize=65,t.loadFile=()=>{t.loadingFile=!0;new FileReader},t.saveDataURI=e=>{a.post("/user/changeAva",{img:e}).then(e=>{t.doUser(e.data)})},t.possibleInterests=[{name:"General PvE",warn:!1,active:!1,icon:"pve.png"},{name:"sPvP",warn:!1,active:!1,icon:"pvp.png"},{name:"WvW",warn:!1,active:!1,icon:"wvw.png"},{name:"Fractals",warn:!1,active:!1,icon:"fracs.png"},{name:"Raids",warn:!0,active:!1,icon:"raids.png"},{name:"Role-Playing",warn:!0,active:!1,icon:"rp.png"}],t.tzs=angular.copy(l),t.changeInterest=(e,o)=>{console.log(e),e.warn&&e.active&&bulmabox.alert("Game Mode Warning",`Hey! Just so you know, Brethren generally doesn't do ${e.name}.<br>However, that doesn't mean we don't have people that might be interested!`),a.get(`/user/changeInterest?int=${o}&act=${e.active}`).then((function(e){t.doUser(e.data)}))},t.changeTz=()=>{a.get("/user/changeTz?tz="+t.user.tz).then(e=>{t.doUser(e.data)})},t.otherInfTimer=null,t.setOtherInfTimer=()=>{t.otherInfTimer&&clearTimeout(t.otherInfTimer),t.otherInfTimer=setTimeout((function(){a.post("/user/changeOther",{other:t.user.otherInfo}).then(e=>{t.doUser(e.data)})}),500)},t.memNameSort=!1,t.charSearch="",t.pickedInts=[!1,!1,!1,!1,!1,!1],t.intSearchToggle=!1,t.charSearchToggle=!1,t.memFilter=e=>{let a=!!e.chars&&!!e.chars.length&&!!e.chars.filter(e=>e.name.toLowerCase().indexOf(t.charSearch.toLowerCase())>-1);if(t.charSearch&&!a)return!1;if(t.pickedInts.filter(e=>!!e).length){let a=!0;return t.pickedInts.forEach((t,o)=>{t&&!e.ints[o]&&(a=!1)}),a}return!0},t.getMembers=()=>{a.get("/user/allUsrs").then(a=>{console.log("all users is",a),t.allUsers=a.data,t.allUsers.forEach(e=>{e.hasInts=!!e.ints.find(e=>"1"==e)}),setTimeout((function(){e.emit("getOnline",{})}),100)})},t.getMembers(),e.on("allNames",(function(e){if(e.user)return!1;t.allUsers&&t.allUsers.forEach(a=>{a.online=!!e.find(e=>e.name==a.user)||a.user==t.user.user}),t.$digest()})),t.getOnlineStatus=e=>e.online?"background:#0f0;box-shadow: 0 0 4px #0f0":"background:#300;",t.showTab=e=>{t.currTab=e},t.currTab="Profile/Characters",t.explRank=()=>{bulmabox.alert("Member Rank",'\n        This is the guild rank of each member (viewable by pressing "G" in game).<br>\n        To get <i>your</i> rank to display:<br>\n        <ol>\n        <li>Head on over to the Profile/Characters tab</li>\n        <li>Fill in your Guild Wars 2 Account name. Note that this is <i>NOT</i> your username, and is instead the "code" that appears at the top of the window when you press "Y"!</li>\n        <li>Click "<i class="fa fa-check"></i>&nbsp;Save Account"</li>\n        </ol>\n        ')},t.makeMod=e=>{console.log("wanna mod",e),bulmabox.confirm("Assign Moderator Rights",`Warning: This will give user ${e.user} full moderator rights, and prevents them from being banned. This process is <i>not</i> reversable!`,(function(o){if(!o||null==o)return!1;a.get("/user/makeMod?user="+e.user).then(e=>{t.allUsers=e.data})}))},t.toggleBan=e=>{a.get("/user/toggleBan?user="+e.user).then(e=>{t.allUsers=e.data})},t.confirmUsr=e=>{bulmabox.confirm("Confirm User",`Are you sure you wish to confirm user ${e.user}?`,o=>{o&&null!=o&&a.get("/user/confirm?u="+e.user).then(e=>{t.allUsers=e.data})})},t.races=["Asura","Charr","Human","Norn","Sylvari"],t.profs=["Guardian","Warrior","Revenant","Thief","Ranger","Engineer","Elementalist","Mesmer","Necromancer"],t.addChar=()=>{const e=t.races.map(e=>`<label class='char-opt opt-${e}'><input type='radio' name='char-race' value=${e} title=${e}><div></div></label>`).join(""),o=t.profs.map(e=>`<label class='char-opt opt-${e}'><input type='radio' name='char-prof' value=${e} title=${e}><div></div></label>`).join("");bulmabox.custom("Add a character",`<div class="field">\n    <label class="label">\n        Name\n    </label>\n    <p class="control has-icons-left">\n        <input class="input" type="text" placeholder="Your character's name" id='char-name'>\n        <span class="icon is-small is-left">\n            <i class="fa fa-user"></i>\n        </span>\n    </p>\n</div>\n<div class="field">\n    <label class='label'>\n        Race\n    </label>\n    ${e}\n</div>\n<div class="field">\n    <label class='label'>\n        Profession\n    </label>\n    ${o}\n</div>\n<div class="field">\n    <label class='label'>\n        Level\n    </label>\n    <p class="control">\n        <input class='input' type='number' id='char-lvl' min='1' max='80' value='80'>\n    </p>\n</div>\n<div class="field">\n    <label class='label'>\n        Other Info\n    </label>\n    <p class="control">\n        <textarea class='textarea' id='char-other' placeholder='Any other information you wanna include (optional)'></textarea>\n    </p>\n</div>`,(function(){const e=document.querySelector("input[name=char-prof]:checked"),o=document.querySelector("input[name=char-race]:checked"),n=document.querySelector("#char-name");if(!e||!o||!n)return bulmabox.alert("Needs More Info","You need to specify a profession, race, and name! Otherwise we won't know who/what you are!"),!1;const r={name:document.querySelector("#char-name").value,prof:document.querySelector("input[name=char-prof]:checked").value,race:document.querySelector("input[name=char-race]:checked").value,lvl:document.querySelector("#char-lvl").value,other:document.querySelector("#char-other").value};console.log("User wants to add char",r),a.post("/user/addChar",r).then(e=>{t.doUser(e.data)})}),"<button class='button is-info' onclick='bulmabox.runCb(bulmabox.params.cb)'>Save</button><button class='button is-danger' onclick='bulmabox.kill(\"bulmabox-diag\")'>Cancel</button>")},t.autoChars=()=>{bulmabox.prompt("Auto-Fill Characters from API","Auto-filling characters from the Guild Wars 2 Official API will replace any existing characters you've entered with API-found characters. <br><br> - You'll need an API key to do this (click <a href='https://account.arena.net/' target='_blank'>here</a> if you dont have one). <br><br>Are you sure you wish to do this?",(function(e){e&&null!=e&&a.get("/user/charsFromAPI?api="+e).then(e=>{console.log("Auto-char response is",e),e&&e.data&&"err"!=e.data?t.doUser(e.data):bulmabox.alert("Error Auto-Filling","There was an error auto-filling your characters.<br>While it <i>may</i> be Dave's fault, you may also wanna check that your API key is valid. You can also always just manually add your characters!")})}))},t.delChr=e=>{console.log("user wishes to remove character",e),bulmabox.confirm("Remove Character",`Are you sure you wish to remove the character ${e.name}?`,(function(o){o&&null!=o&&a.get("/user/remChar?id="+e._id).then(e=>{t.doUser(e.data)}).catch(e=>{bulmabox.alert("Error","There was a problem removing this character!")})}))},t.editChar=e=>{console.log("usr wants to",e,Date.now());const o=t.races.map(t=>`<label class='char-opt opt-${t}'><input type='radio' name='char-race' value=${t} title=${t} ${t==e.race?"checked":""}><div></div></label>`).join(""),n=t.profs.map(t=>`<label class='char-opt opt-${t}'><input type='radio' name='char-prof' value=${t} title=${t} ${t==e.prof?"checked":""}><div></div></label>`).join("");bulmabox.custom("Edit character",`<div class="field">\n    <label class="label">\n        Name\n    </label>\n    <p class="control has-icons-left">\n        <input class="input" type="text" placeholder="Your character's name" id='char-name' value='${e.name}'>\n        <span class="icon is-small is-left">\n            <i class="fa fa-user"></i>\n        </span>\n    </p>\n</div>\n<div class="field">\n    <label class='label'>\n        Race\n    </label>\n    ${o}\n</div>\n<div class="field">\n    <label class='label'>\n        Profession\n    </label>\n    ${n}\n</div>\n<div class="field">\n    <label class='label'>\n        Level\n    </label>\n    <p class="control has-icons-left">\n        <input class='input' type='number' id='char-lvl' min='1' max='${e.lvl}' value='80'>\n        <span class="icon is-small is-left">\n            <i class="fa fa-signal"></i>\n        </span>\n    </p>\n</div>\n<div class="field">\n    <label class='label'>\n        Other Info\n    </label>\n    <p class="control">\n        <textarea class='textarea' id='char-other' placeholder='Any other information you wanna include (optional)'>${e.other}</textarea>\n    </p>\n</div>`,(function(e){const o=document.querySelector("input[name=char-prof]:checked"),n=document.querySelector("input[name=char-race]:checked"),r=document.querySelector("#char-name");if(!o||!n||!r)return bulmabox.alert("Needs More Info","You need to specify a profession, race, and name! Otherwise we won't know who/what you are!"),!1;const s={name:document.querySelector("#char-name").value,prof:document.querySelector("input[name=char-prof]:checked").value,race:document.querySelector("input[name=char-race]:checked").value,lvl:document.querySelector("#char-lvl").value,other:document.querySelector("#char-other").value};console.log("User wants to add char",s,e),a.post("/user/editChar",s).then(e=>{t.doUser(e.data)})}),"<button class='button is-info' onclick='bulmabox.runCb(bulmabox.params.cb)'>Save</button><button class='button is-danger' onclick='bulmabox.kill(\"bulmabox-diag\")'>Cancel</button>")},t.mail=e=>{bulmabox.custom("Send Message","<div class=\"field\">\n    <label class='label'>\n        Message\n    </label>\n    <p class=\"control\">\n        <textarea class='textarea' id='newMsg' placeholder='What do you wanna say?'></textarea>\n    </p>\n</div>",(function(t){const o=document.querySelector("#newMsg").value;if(!o)return bulmabox.alert("Huh?","Sorry, but we don't support uncomfortable silences currently."),!1;a.post("/user/sendMsg",{msg:o,to:e.user}).then(e=>{})}),"<button class='button is-info' onclick='bulmabox.runCb(bulmabox.params.cb)'>Send</button><button class='button is-danger' onclick='bulmabox.kill(\"bulmabox-diag\")'>Cancel</button>")},t.viewMsg=(e,o)=>{if(bulmabox.alert(`Message from ${e.from}`,e.msg||"(No message)"),o)return!1;a.get("/user/setOneRead?id="+e._id).then(e=>{t.doUser(e.data)})},t.delMsg=e=>{bulmabox.confirm("Delete Message","Are you sure you wish to delete this message?",o=>{console.log("resp",o),o&&null!=o&&a.get("/user/delMsg?id="+e._id).then(e=>{t.doUser(e.data)})})},t.delMyMsg=e=>{bulmabox.confirm("Delete Message","Are you sure you wish to delete this message?",o=>{console.log("resp",o),o&&null!=o&&a.get("/user/delMyMsg?id="+e._id).then(e=>{t.doUser(e.data)})})},t.repMsg=e=>{console.log("user wishes to report msg",e),bulmabox.confirm("Report Message","Reporting a message sends a notification to the moderators, including the details of the message.<br>It will then be up to the moderators to determine if you're being uncool to each other.<br>Are you sure you wish to report this message?",t=>{a.post("/user/repMsg",e).then(e=>{"dupRep"==e.data&&bootbox.alert("Already Reported","You've already reported this message. Please wait while the moderator team reviews your report.")})})},t.newPwd={pwd:null,pwdDup:null,old:null,changin:!1},t.clearPwd=()=>{t.newPwd={pwd:null,pwdDup:null,old:null,changin:!1}},t.editPwd=()=>{t.newPwd.pwd&&t.newPwd.pwdDup&&t.newPwd.pwd==t.newPwd.pwdDup?a.put("/user/editPwd",t.newPwd).then(e=>{e.data&&"err"!=e.data?(t.clearPwd(),bulmabox.alert("Password Changed!","Your password was successfully changed!"),t.doUser(e.data)):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Error Changing Password',"There was a problem changing your password. Your old one probably still works, but if you're still having an issue, contact a moderator!")}):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Password Mismatch',"Your passwords don't match, or are missing!")},t.viewEvent=e=>{bulmabox.alert(`Event: ${e.title}`,`Date:${n("numToDate")(e.eventDate)}<br>Description:${e.text}`)}}]).filter("numToDate",(function(){return function(e){if(isNaN(e))return"Invalid date!";const t=new Date(e);return console.log(t.getMinutes()),`${t.toLocaleDateString()} ${t.getHours()%12}:${t.getMinutes().toString().length<2?"0"+t.getMinutes():t.getMinutes()} ${t.getHours()<13?"AM":"PM"}`}}));new showdown.Converter;const i=["http://www.youtube.com/watch?v=&lt;VIDEO-CODE&gt;","http://www.youtube.com/v/&lt;VIDEO-CODE&gt;","http://youtu.be/&lt;VIDEO-CODE&gt;","https://www.youtube.com/embed/&lt;VIDEO-CODE&gt;","&lt;VIDEO-CODE&gt;"];t.controller("edit-cont",["$scope","$sce","$http","imgTypes","vidTypes","defBlg","$log",(e,t,a,o,n,r,s)=>{e.postList=null,e.getAllPosts=t=>{a.get("/blog/allBlogs").then(a=>{e.postList=a.data.sort((e,t)=>e.time-t.time),e.currBlg=(t?e.postList.find(e=>e.pid==t):e.postList[0]).copy(),s.debug("ALL POSTS",e.postList,"SELECTED POST",e.currBlg)})},e.getAllPosts(),e.toDate=e=>new Date(e).toLocaleString(),e.includesFormat=(e,t)=>"vid"==e&&n.includes(t)||"img"==e&&o.includes(t),e.getYoutubeUrl=e=>t.trustAsResourceUrl(`https://www.youtube.com/embed/${e}?controls=0`),e.edit={hasMedia:!1},e.mediaEdit={},e.blgInst=r,e.parseMd=e=>e&&e.sanAndParse().md2h(),e.hideInst=!0,e.changeMedia=function(){e.getMediaInfo(e.currBlg.media.url).then(t=>{e.currBlg.media=t.copy(),e.edit.media=!1,e.$digest()})},e.getMediaInfo=function(e){return new Promise((function(t,r){const l=/^(?:https?:\/\/)?(?:www\.)?(?:youtu\.be\/|youtube\.com\/(?:embed\/|v\/|watch\?v=|watch\?.+&v=))((\w|-){11})(?:\S+)?$/;return s.debug("at top of promise, url is",e),e.match(l)?t({mediaType:"youtube",url:RegExp.$1}):`https://youtu.be/${e}`.match(l)?t({mediaType:"youtube",url:e}):void a.get(e).then(a=>{const l=a.headers()["content-type"].split("/");return s.debug(a,a.headers(),l),o.includes(l[1])||n.includes(l[1].split(";")[0])?t({mediaType:l[1],url:e}):(bulmabox.alert("Unsupported File Type",`Sorry, but we don't currently support that file type (we think it's ${l[1]}).<br/>\n                    Supported file types are:<br/>\n                    <div class='content columns'>\n                        <div class='column'>\n                            <strong><i class='fa fa-picture-o'></i>&nbsp;Images:</strong>\n                            <ul>\n                                ${o.map(e=>"<li>."+e.toUpperCase()+"</li>").join("")}\n                            </ul>\n                        </div>\n                        <div class='column'>\n                            <strong><i class='fa fa-video-camera'></i>&nbsp;Videos:</strong>\n                            <ul>\n                                ${n.map(e=>"<li>."+e.toUpperCase()+"</li>").join("")}\n                            </ul>\n                            <br/>\n                            <strong><i class='fa fa-youtube-square'></i>&nbsp;Youtube:</strong>\n                            <ul>\n                                ${i.map(e=>"<li>"+e+"</li>").join("")}\n                            </ul>\n                        </div>\n                    </div>`),r(!1))},e=>(bulmabox.alert("Cannot Read","<div class='content'>Sorry, but we can't read that external file. Check to make sure:\n                <ul>\n                <li>The file actually exists at the specified location (i.e., you spelled the URL correctly)</li>\n                <li>The file is publically available (i.e., does not require authorization or something)</li>\n                <li>The file is not protected by Cross-Origin Resource Sharing protocols, aka the stupidest idea anyone on the internet ever came up with (<a href='https://en.wikipedia.org/wiki/Cross-origin_resource_sharing'>here</a>).</li>\n                </ul>\n                </div>"),r(!1)))}))},e.waitings={},e.emptyBlog={title:"Enter a title",pid:null,txtMd:"Tell us something!",media:{url:"",mediaType:null}},e.verifyBlgCh=t=>{e.waitings.changeBlg=!0,s.debug("CurrBlg?",e.currBlg,"hasEdit",t),e.currBlg&&a.get("/blog/blog?pid="+e.currBlg.pid).then(a=>{a.data&&[a.data.title!=e.currBlg.title,a.data.media.mediaType!=e.currBlg.media.mediaType,a.data.media.url!=e.currBlg.media.url,a.data.txtMd!=e.currBlg.txtMd].filter(e=>!!e).length?bulmabox.confirm('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Discard changes',`The blog post ${e.currBlg.title} has been modified. Switching blogs posts now will discard those changes. Switch anyway?`,a=>{a?(s.debug("current blog was changed. Said yes to discard; discarding and changing"),e.currBlg=t?t.copy():e.emptyBlog.copy()):e.candBlg="",e.waitings.changeBlg=!1,e.$digest()}):(e.currBlg=t?t.copy():e.emptyBlog.copy(),e.waitings.changeBlg=!1)})},e.saveBlog=e=>{let t;t=e.pid?"PUT":"POST",e.txtHtml=null,a({method:t,url:"/blog/blog",data:e}).then(e=>{bulmabox.alert("Saved!","Your post has been saved!")})}}]),t.controller("forum-cat-cont",["$scope","$http","$state","$location",function(e,t,a,o){localStorage.brethUsr||a.go("app.login"),t.get("/user/getUsr").then(t=>{e.user=t.data,console.log("user",e.user)}),e.newThr={},e.fileName=null,e.currCat=o.search().c,e.refCat=()=>{t.get("/forum/byCat?grp="+e.currCat).then((function(t){console.log("thrds in this cat",t),e.threads=t.data.sort((e,t)=>e.stickied===t.stickied?e.lastUpd-t.lastUpd:e.stickied?-1:1).map(e=>(e.time=new Date(e.lastUpd),e))}))},e.refCat(),e.newThrDial=()=>{e.makingThread=!0},e.clearThread=()=>{e.newThr={},e.makingThread=!1,e.loadingFile=!1},e.loadFile=()=>{e.loadingFile=!0;new FileReader},e.deleteThread=(e,o)=>{e.stopPropagation(),e.preventDefault(),bulmabox.confirm("Delete Thread",`Are you absolutely sure you wish to delete the thread '${o.title}'? <br>Please note that this process is <em>not</em> reversable!`,e=>{if(!e||null==e)return!1;console.log("Deleting thread",o),t.delete("/forum/deleteThread?id="+o._id).then(e=>{a.go(a.current,{},{reload:!0})})})},e.makeThread=()=>{e.newThr.md=e.newThr.txt,e.newThr.text=(new showdown.Converter).makeHtml(e.newThr.txt),e.newThr.grp=e.currCat,t.post("/forum/newThread",e.newThr).then((function(e){console.log("new thred response",e),a.go(a.current,{},{reload:!0})}))},e.toggleSticky=(a,o)=>{a.stopPropagation(),a.preventDefault(),t.get("/forum/toggleSticky?id="+o).then(t=>{console.log("response from thread sticky toggle is",t),e.refCat()})},e.toggleLock=(a,o)=>{a.stopPropagation(),a.preventDefault(),t.get("/forum/toggleLock?id="+o).then(t=>{console.log("response from thread lock toggle is",t),e.refCat()})}}]),t.controller("forum-cont",["$scope","$http","$state","$sce",function(e,t,a,o){e.currMsg=0,e.forObj={},localStorage.brethUsr||a.go("app.login"),t.get("/forum/cats").then(t=>{const a=Object.keys(t.data);console.log("CATS",t),e.forObj=a.map(e=>({name:e,count:t.data[e].n,time:t.data[e].t>0?new Date(t.data[e].t):null}))}),e.searchin=!1,e.search="",e.searchTimer=null,e.doSearch=()=>{e.searchTimer&&clearTimeout(e.searchTimer),e.searchTimer=setTimeout((function(){e.search&&e.search.length&&t.post("/forum/searchThr",{term:e.search}).then(t=>{console.log("search response",t),e.searchResults=t.data})}),500)},e.goCat=function(e){a.go("app.forumCat",{c:e})}}]),t.controller("forum-thr-cont",["$scope","$http","$state","$location","$sce",function(e,t,a,o,n){e.currMsg=0,e.defaultPic=r,e.forObj={},e.fileName=null,localStorage.brethUsr||a.go("app.login"),e.loadingFile=!1,e.loadFile=()=>{e.loadingFile=!0;new FileReader},e.currCat=o.search().c,e.id=o.search().t,e.refThred=()=>{console.log("info to back:",e.id),t.get("/forum/thread?id="+e.id).then(t=>{console.log("response",t),e.thr=t.data.thrd,t.data.psts.map(e=>(e.rawText=e.text,e.text=n.trustAsHtml(e.text),e.date=new Date(e.lastUpd).toLocaleString(),e.wasEdited=e.lastUpd!=e.createDate,e)),e.avas=t.data.ava,e.thr.posts=e.thr.posts.map(e=>{const a=t.data.psts.filter(t=>t._id==e.id)[0];return a.votesUp=e.votesUp,a.votesDown=e.votesDown,a.byMod=t.data.mods.indexOf(a.user)>-1,a.order=e.order,t.data.psts.filter(t=>t._id==e.id)[0]}).sort((e,t)=>e.order-t.order),console.log("thred response",e.thr,t)})},e.refThred(),t.get("/user/getUsr").then(t=>{e.user=t.data,console.log("user",e.user)}),e.newPost=()=>{let a=document.querySelector("#postTxt").value;if(console.log("new POST",a,e.fileread),!a&&!e.fileread)return bulmabox.alert("Say Something","You can't just post nothing!"),!1;t.post("/forum/newPost",{thread:e.thr._id,md:a,file:e.fileread||null}).then(e=>{window.location.reload()})},e.vote=(a,o)=>{console.log("voting for",a,"direction",o,"which is",typeof o),t.post("/forum/vote",{thread:a.thread,post:a._id,voteUp:!!o}).then(t=>{console.log("vote response is:",t),e.refThred()})},e.quoteMe=e=>{document.querySelector("#postTxt").value=e.md.split("\n").map(e=>">"+e).join("\n")},e.getBuildTimer=null,e.currBuild={data:null}}]),t.controller("help-cont",["$scope","$sce",(e,t)=>{e.tabs=[{title:"General Usage",icon:"users"},{title:"Posting and Formatting",icon:"pencil-square"},{title:"Terms of Service and Rules.",icon:"gavel"}],e.siteSections=[{title:"Home",descs:["Only viewable while logged out","See blog entries posted by our mod team!"],icon:""},{title:"Dashboard",descs:["View and edit your personal information, such as characters, account name, or game preferences","Look at other members' profiles","Send and receive messages from other Brethren members","View a list of upcoming events"],icon:"tachometer"},{title:"Calendar",descs:["Create, edit, or just view guild events","It's a work in progress, so lemme know if it breaks!"],icon:"calendar"},{title:"Chat",descs:["Talk with other guild members!","Chat is <em>not</em> preserved, but still, be nice!",'See the <i class="fa fa-pencil-square"></i>&nbsp;Posting and Formatting tab for more details on how to make your text awesome.'],icon:"comments"},{title:"Forums",descs:["Got a message you want everyone to see? Post it here","You can even include a (relatively small!) picture","Be nice!","You can vote on posts too, if that's your thing.",'See the <i class="fa fa-pencil-square"></i>&nbsp;Posting and Formatting tab for more details on how to make your text awesome.'],icon:"commenting-o"},{title:"Tools",descs:['Contains a bunch of "convenience" tools',"List of today's and tomorrow's daily achievements (only for general, fractal, pvp, and wvw dailies for now!)","Current World versus World (WvW) matchup statistics","Core to Lodestone upgrade calculator","Tier six fine material upgrade calculator"],icon:"wrench"},{title:"Help",descs:["You're looking at it. Hi!"],icon:"question-circle"}],e.currTab=0,e.setTab=t=>{e.currTab=t},e.mdCodes=[{md:"*text*, _text_",html:"<em>text</em>",notes:"Italic text."},{md:"**text**",html:"<b>text</b>",notes:"Bold text."},{md:"#text",html:"<span class='is-size-3'>text</span>",notes:'Bigger text. The more "#"s there are, the <em>smaller</em> the text will be (up to a maximum of 6).'},{md:"[link text](https://www.google.com)",html:"<a href='https://www.google.com'>link text</a>",htmlReal:"<a href='https://www.google.com' class='no-blue-link' target='_blank'>link text</a>",notes:"Creates a link."},{md:"|ColumnA|ColumnB|ColumnC|\n        |---|---|---|\n        |apple|banana|cherry|\n        |Airedale|Bichon|Chihuahua|",html:"<table>\n        <thead>\n            <tr>\n                <th>ColumnA</th>\n                <th>ColumnB</th>\n                <th>ColumnC</th>\n            </tr>\n        </thead>\n        <tbody>\n            <tr>\n                <td>apple</td>\n                <td>banana</td>\n                <td>cherry</td>\n            </tr>\n            <tr>\n                <td>Airedale</td>\n                <td>Bichon</td>\n                <td>Chihuahua</td>\n            </tr>\n        </tbody>\n    </table>",htmlReal:"<table>\n        <thead>\n            <tr>\n                <th style='color:#222;!important'>ColumnA</th>\n                <th style='color:#222;!important'>ColumnB</th>\n                <th style='color:#222;!important'>ColumnC</th>\n            </tr>\n        </thead>\n        <tbody>\n            <tr>\n                <td>apple</td>\n                <td>banana</td>\n                <td>cherry</td>\n            </tr>\n            <tr>\n                <td>Airedale</td>\n                <td>Bichon</td>\n                <td>Chihuahua</td>\n            </tr>\n        </tbody>\n    </table>",notes:"Creates a table."},{md:"Unda da [c='blue']sea[/c]!",html:"Unda da <span style='color:blue;'>sea</span>!",notes:"Colored text. For you code-savvy folks, this accepts any CSS-compatible color format, including color names, hex, RGB, and HSL"},{md:"![awesome img description](some-img-address)",html:"<img src='some-img-address' alt='awesome img description'/>",html:"<img src='http://localhost:8080/img/icons/android-icon-72x72.png' alt='awesome img description'/>",notes:"An image. Must be hosted somewhere else!"},{md:"`foo==bar`",html:"<code>foo==bar</code>",notes:"Inline code."},{md:"\n        ```\n        awesomeCode('isAwesome');\n        ```\n        ",html:"<pre>            \nawesomeCode('isAwesome');\n</pre>\n        ",notes:'Pre-formatted code "block".'},{md:"[&DQgnNzI1Ii6bAAAAgAAAAHYAAABwAQAAkgAAAAAAAAAAAAAAAAAAAAAAAAA=]",html:"(build code)",htmlReal:"<build-template build='[&DQgnNzI1Ii6bAAAAgAAAAHYAAABwAQAAkgAAAAAAAAAAAAAAAAAAAAAAAAA=]'></build-template>",notes:"Creates a clickable build code."}],e.trustMe=e=>t.trustAsHtml(e)}]),t.controller("home-cont",["$scope","$http","$state","$sce","imgTypes","vidTypes","defBlg","$log","$compile",function(e,t,a,o,n,r,s,i,l){t.get("/user/memberCount").then(t=>{e.memberCount={counts:t.data,types:Object.keys(t.data)},i.debug("MEMBERS",e.memberCount),e.currMems=0,setInterval((function(){document.querySelector("#fadey-count").classList.add("fader-on"),setTimeout((function(){e.currMems=(e.currMems+1)%(e.memberCount.types.length-1),e.$digest(),document.querySelector("#fadey-count").classList.remove("fader-on")}),760)}),1e4)}),e.defBlg=s,e.currVid=null,e.blogs=[],e.getPosts=a=>{t.get("/blog/blogs?n=5&s="+(a||0)).then(t=>{const a=e.blogs.map(e=>e.title);i.debug(a),e.blogs=e.blogs.concat(t.data.filter(e=>!a.includes(e.title))),e.gettingBlogs=!1})},e.getPosts(),e.includesFormat=(e,t)=>"vid"==e&&r.includes(t)||"img"==e&&n.includes(t),e.getYoutubeUrl=e=>o.trustAsResourceUrl(`https://www.youtube.com/embed/${e}?controls=0`),e.toDate=e=>new Date(e).toLocaleString(),document.addEventListener("scroll",(function(t){var a;a=document,Math.max(a.body.scrollHeight,a.documentElement.scrollHeight,a.body.offsetHeight,a.documentElement.offsetHeight,a.body.clientHeight,a.documentElement.clientHeight)<=("number"==typeof window.pageYOffset?window.pageYOffset:document.body&&(document.body.scrollLeft||document.body.scrollTop)?document.body.scrollTop:document.documentElement&&(document.documentElement.scrollLeft||document.documentElement.scrollTop)?document.documentElement.scrollTop:void 0)+window.innerHeight+50&&!e.gettingBlogs&&(i.debug("BOTTOMED"),e.gettingBlogs=!0,e.getPosts(e.blogs[e.blogs.length-1].time))})),e.goLogin=function(){a.go("appSimp.login")}}]),t.controller("inbox-cont",["$scope","$http","userFact",function(e,t,a){e.currMsg=0,console.log("PARENT USER IS:",e.$parent.user),e.chMsg=function(t){t&&e.currMsg<e.$parent.user.msgs.length-1?(console.log("goin up 1 msg"),e.currMsg++):!t&&e.currMsg>0&&e.currMsg--,e.$digest()},e.interpDate=function(e){return new Date(e).toUTCString()},e.reply=function(){a.writeMsg(e.$parent.user.msgs[e.currMsg].from,e.$parent.user.name,!0)},e.deleteMsg=function(){bootbox.confirm("Are you sure you wish to delete this message? Deleted messages are <i>not</i> recoverable!",(function(a){a&&null!=a&&t.post("/user/delMsg",{user:e.$parent.user.name,id:e.$parent.user.msgs[e.currMsg].id}).then((function(t){t.data&&t.data.name?(e.$parent.user=t.data,console.log("affected user",e.$parent.user),angular.element("body").scope().$digest(),e.currMsgs=Math.min(e.$parent.user.msgs.length-1,e.currMsgs)):"err"==t.data&&bootbox.alert("Error deleting message!")}))}))}}]),t.controller("log-cont",["$scope","$http","$state","$q","userFact",function(t,a,o,n,r){t.noWarn=!1,t.nameOkay=!0,delete localStorage.brethUsr,t.checkTimer=!1,t.goReg=()=>{o.go("appSimp.register")},t.goLog=()=>{o.go("appSimp.login")},t.doForgot=()=>{bulmabox.kill("bulmabox"),a.get("/user/forgotToMods?u="+t.user).then(e=>{bulmabox.alert})},t.forgot=()=>{a.get("/user/okayToReset?u="+t.user).then(e=>{if(!t.user)return bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Need Username',"We can't help you reset your password if you don't tell us who you are!");bulmabox.custom('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Forgot Password',"Forgot your password? Click the magic button below, and one of the [PAIN] moderators will reset your password! <br>NOTE: You'll need to talk to a PAIN officer in game to recieve your temporary password.",()=>{a.get("/user/requestReset?u="+t.user).then(e=>{alert("Done!")})},"<button class='button is-info' onclick='bulmabox.runCb(bulmabox.params.cb,true)'><i class='fa fa-check'></i>&nbsp;Ask for reset</button>")}).catch(e=>{bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbspCan\'t reset password',"Unfortunately, we can't reset the password for that username. Please contact a [PAIN] officer in-game for further details.")})},t.backHome=()=>{o.go("appSimp.home")},t.signin=()=>{a.put("/user/login",{user:t.user,pass:t.pwd}).then(a=>{console.log(a),"authErr"==a.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Incorrect Login',"Either your username or password (or both!) are incorrect."):"banned"==a.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Banned',"You've been banned! We're a pretty laid-back guild, so you must have <i>really</i> done something to piss us off!"):"expPwd"==a.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Expired Password',"That password's expired! Please ask a moderator to reset your password, and this time <i>remember</i> to change it!"):(console.log("LOGIN RESPONSE",a.data),e.emit("chatMsg",{msg:`${t.user} logged in!`}),a.data.news&&bulmabox.alert("Updates/News",`Since you last logged in, the following updates have been implemented:<br><ul style='list-style:disc;'><li>${a.data.news.join("</li><li>")}</li></ul>`),localStorage.brethUsr=JSON.stringify(a.data.usr),o.go("app.dash"))}).catch(e=>{bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Error',"There's been some sort of error logging in. This is <i>probably</i> not an issue necessarily with your credentials. Blame Dave!"),console.log(e)})},t.checkUser=()=>{t.checkTimer&&clearTimeout(t.checkTimer),t.checkTimer=setTimeout((function(){a.get("/user/nameOkay?name="+t.user).then(e=>{t.nameOkay=e.data})}),500)},t.register=()=>{t.pwd&&t.pwdDup&&t.user?t.pwd!=t.pwdDup?(console.log("derp"),bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Password Mismatch',"Your passwords don't match, or are missing!")):t.account?a.post("/user/new",{user:t.user,pass:t.pwd,account:t.account}).then(e=>{a.put("/user/login",{user:t.user,pass:t.pwd}).then(()=>{o.go("app.dash")})}).catch(e=>{console.log(e),bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Problem Registering',"Sorry, but there was an issue with registering your account. Please contact HealyUnit in game if you have further issues. Please tell him<br/>")}):bulmabox.confirm('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Send Without Account?',"You've not included Guild Wars 2 account! <br>While you can register without a gw2 account name, certain features will be unavailable.<br>Register anyway?",(function(e){if(!e||null==e)return!1;a.post("/user/new",{user:t.user,pass:t.pwd,account:t.account}).then(e=>{a.put("/user/login",{user:t.user,pass:t.pwd}).then(()=>{o.go("app.dash")})}).catch(e=>{console.log(e),bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Problem Registering',`Sorry, but there was an issue with registering your account. Please contact HealyUnit (me) in game/on discord if this continues to happen, and tell me the following error info:<br/>\n                    <div class='message has-background-grey-lighter'>\n                        Error:{<br/>\n                        &nbsp;status:${e.status},<br/>\n                        &nbsp;data:'${JSON.stringify(e.data)}'<br/>\n                        }\n                    </div><br/>\n                    Thanks!\n                    `)})})):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Missing Information',"Please enter a username, and a password (twice).")}}]),String.prototype.capMe=function(){return this.slice(0,1).toUpperCase()+this.slice(1)},t.controller("main-cont",["$scope","$http","$state","userFact",function(t,a,o,n){console.log("main controller registered!"),t.user=null,n.getUser().then(a=>{t.user=a.data,e.emit("hiIm",{name:t.user.user})}),e.on("reqHeartBeat",(function(a){if(!t.user)return!1;e.emit("hbResp",{name:t.user.user})}))}]),t.controller("nav-cont",["$scope","$http","$state","userFact",function(e,t,a,o){e.logout=function(){bulmabox.confirm("Logout","Are you sure you wish to logout?",(function(o){if(!o||null==o)return!0;e.$parent.$parent.user=null,t.get("/user/logout").then((function(e){a.go("appSimp.home")}))}))},e.pages=[{sref:"app.dash",txt:"Dashboard",icon:"tachometer"},{sref:"app.calendar",txt:"Calendar",icon:"calendar"},{sref:"app.chat",txt:"Chat",icon:"comments"},{sref:"app.forum",txt:"Forum",icon:"commenting-o"},{sref:"app.tools",txt:"Tools",icon:"wrench"},{sref:"app.blog",txt:"Blog Editor",icon:"pencil",protected:!0}],e.mobActive=!1}]),a.controller("reset-contr",["$scope","$http","$location",function(e,t,a){e.key=window.location.search.slice(5),t.get("/user/resetUsr?key="+e.key).then((function(t){console.log("getting reset user status?",t),e.user=t.data})),e.doReset=function(){e.user&&e.pwd&&e.pwdDup&&e.pwdDup==e.pwd&&e.key?t.post("/user/resetPwd",{acct:e.user.user,pwd:e.pwd,pwdDup:e.pwdDup,key:e.key}).then((function(t){console.log(""),"err"==t.data?bulmabox.alert("Error resetting password","There was an error resetting your password. Please contact a mod"):bulmabox.alert("Password Reset","Your password was successfully reset! We're redirecting you to login now.",(function(){e.goLogin()}))})):bulmabox.alert("Error: Missing data","Make sure you&rsquo;ve reached this page from a password reset link, and that you have entered the same password in both fields!")},e.goLogin=()=>{window.location.href="../../login"}}]);const l=[{value:-12,text:"(GMT -12:00) Eniwetok, Kwajalein"},{value:-11,text:"(GMT -11:00) Midway Island, Samoa"},{value:-10,text:"(GMT -10:00) Hawaii"},{value:-9,text:"(GMT -9:00) Alaska"},{value:-8,text:"(GMT -8:00) Pacific Time (US & Canada)"},{value:-7,text:"(GMT -7:00) Mountain Time (US & Canada)"},{value:-6,text:"(GMT -6:00) Central Time (US & Canada), Mexico City"},{value:-5,text:"(GMT -5:00) Eastern Time (US & Canada), Bogota, Lima"},{value:-4,text:"(GMT -4:00) Atlantic Time (Canada), Caracas, La Paz"},{value:-3.5,text:"(GMT -3:30) Newfoundland"},{value:-3,text:"(GMT -3:00) Brazil, Buenos Aires, Georgetown"},{value:-2,text:"(GMT -2:00) Mid-Atlantic"},{value:-1,text:"(GMT -1:00) Azores, Cape Verde Islands"},{value:0,text:"(GMT) Western Europe Time, London, Lisbon, Casablanca"},{value:1,text:"(GMT +1:00) Brussels, Copenhagen, Madrid, Paris"},{value:2,text:"(GMT +2:00) Kaliningrad, South Africa"},{value:3,text:"(GMT +3:00) Baghdad, Riyadh, Moscow, St. Petersburg"},{value:3.5,text:"(GMT +3:30) Tehran"},{value:4,text:"(GMT +4:00) Abu Dhabi, Muscat, Baku, Tbilisi"},{value:4.5,text:"(GMT +4:30) Kabul"},{value:5,text:"(GMT +5:00) Ekaterinburg, Islamabad, Karachi, Tashkent"},{value:5.5,text:"(GMT +5:30) Bombay, Calcutta, Madras, New Delhi"},{value:5.75,text:"(GMT +5:45) Kathmandu"},{value:6,text:"(GMT +6:00) Almaty, Dhaka, Colombo"},{value:7,text:"(GMT +7:00) Bangkok, Hanoi, Jakarta"},{value:8,text:"(GMT +8:00) Beijing, Perth, Singapore, Hong Kong"},{value:9,text:"(GMT +9:00) Tokyo, Seoul, Osaka, Sapporo, Yakutsk"},{value:9.5,text:"(GMT +9:30) Adelaide, Darwin"},{value:10,text:"(GMT +10:00) Eastern Australia, Guam, Vladivostok"},{value:11,text:"(GMT +11:00) Magadan, Solomon Islands, New Caledonia"},{value:12,text:"(GMT +12:00) Auckland, Wellington, Fiji, Kamchatka"}],c=[{id:1001,name:"Anvil Rock",population:"High"},{id:1002,name:"Borlis Pass",population:"Medium"},{id:1003,name:"Yak's Bend",population:"High"},{id:1004,name:"Henge of Denravi",population:"Medium"},{id:1005,name:"Maguuma",population:"High"},{id:1006,name:"Sorrow's Furnace",population:"Medium"},{id:1007,name:"Gate of Madness",population:"Medium"},{id:1008,name:"Jade Quarry",population:"Medium"},{id:1009,name:"Fort Aspenwood",population:"Full"},{id:1010,name:"Ehmry Bay",population:"Medium"},{id:1011,name:"Stormbluff Isle",population:"Medium"},{id:1012,name:"Darkhaven",population:"Medium"},{id:1013,name:"Sanctum of Rall",population:"VeryHigh"},{id:1014,name:"Crystal Desert",population:"Medium"},{id:1015,name:"Isle of Janthir",population:"Medium"},{id:1016,name:"Sea of Sorrows",population:"VeryHigh"},{id:1017,name:"Tarnished Coast",population:"High"},{id:1018,name:"Northern Shiverpeaks",population:"High"},{id:1019,name:"Blackgate",population:"Full"},{id:1020,name:"Ferguson's Crossing",population:"Medium"},{id:1021,name:"Dragonbrand",population:"Medium"},{id:1022,name:"Kaineng",population:"High"},{id:1023,name:"Devona's Rest",population:"Medium"},{id:1024,name:"Eredon Terrace",population:"Medium"},{id:2001,name:"Fissure of Woe",population:"Medium"},{id:2002,name:"Desolation",population:"VeryHigh"},{id:2003,name:"Gandara",population:"High"},{id:2004,name:"Blacktide",population:"Medium"},{id:2005,name:"Ring of Fire",population:"Medium"},{id:2006,name:"Underworld",population:"Medium"},{id:2007,name:"Far Shiverpeaks",population:"Medium"},{id:2008,name:"Whiteside Ridge",population:"High"},{id:2009,name:"Ruins of Surmia",population:"Medium"},{id:2010,name:"Seafarer's Rest",population:"VeryHigh"},{id:2011,name:"Vabbi",population:"High"},{id:2012,name:"Piken Square",population:"VeryHigh"},{id:2013,name:"Aurora Glade",population:"High"},{id:2014,name:"Gunnar's Hold",population:"Medium"},{id:2101,name:"Jade Sea",population:"High"},{id:2102,name:"Fort Ranik",population:"Medium"},{id:2103,name:"Augury Rock",population:"High"},{id:2104,name:"Vizunah Square",population:"Medium"},{id:2105,name:"Arborstone",population:"Medium"},{id:2201,name:"Kodash",population:"High"},{id:2202,name:"Riverside",population:"Full"},{id:2203,name:"Elona Reach",population:"VeryHigh"},{id:2204,name:"Abaddon's Mouth",population:"Medium"},{id:2205,name:"Drakkar Lake",population:"High"},{id:2206,name:"Miller's Sound",population:"Medium"},{id:2207,name:"Dzagonur",population:"Medium"},{id:2301,name:"Baruch Bay",population:"VeryHigh"}];t.controller("tool-cont",["$scope","$http","$state","$filter","$sce","$window",function(e,t,a,o,n,r){e.showTab=t=>{e.currTab=t,"WvW Current Match History"==e.currTab&&e.refWvw()},e.currTab="Dailies",e.tabs=[{name:"Dailies",icon:"calendar-check-o"},{name:"WvW Current Match History",icon:"fort-awesome"},{name:"Core/Lodestone Upgrade",icon:"diamond"},{name:"Tier Six Material Conversion",icon:"money"}],e.dailyRestrict={},e.tmrw=!1,e.regetDaily=()=>{const a=Object.keys(e.dailyRestrict).filter(t=>e.dailyRestrict[t]);t.get("/tool/daily"+(e.tmrw?"/tomorrow":"")+(a.length?"?modes="+a.join(","):"")).then(t=>{console.log("dailyObj",t.data),e.dailies=t.data})},r.addEventListener("keyup",t=>{39!=t.which||t.shiftKey?39==t.which&&t.shiftKey?(e.lastSkirm(),e.$digest()):37!=t.which||t.shiftKey?37==t.which&&t.shiftKey&&(e.firstSkirm(),e.$digest()):(e.prevSkirm(),e.$digest()):(e.nextSkirm(),e.$digest())}),e.regetDaily(),e.refPrices=()=>{t.get("/tool/allPrices").then(t=>{e.prices=e.calcPrices(t.data.p)})},e.wvwWorld=!1,e.wvwColors=["red","green","blue"],e.wvwPie={cutoutPercentage:0,backgroundColor:["#aa0000","#00aa00","#0000aa"],config:{plugins:{vert:!1}}},e.wvwDisabled=!1,e.makeMarkers=()=>{e.mapMarkers=["camp-blue.png","camp-green.png","camp-netural.png","camp-red.png","castle-blue.png","castle-green.png","castle-neutral.png","castle-red.png","keep-blue.png","keep-green.png","keep-netural.png","keep-red.png","ruins-blue.png","ruins-green.png","ruins-neutral.png","ruins-red.png","tower-blue.png","tower-green.png","tower-neutral.png","tower-red.png"].map(e=>L.icon({iconUrl:"./img/wvw/"+e,iconName:e.replace(".png",""),iconSize:[32,32],iconAnchor:[15,15],popupAnchor:[-3,-76]})),console.log("Map Markers",e.mapMarkers)},e.refWvw=()=>{t.get("/tool/wvw"+(e.wvwWorld?"?world="+e.wvwWorld:"")).then(t=>{if(console.log("WVW STUFF",t,t.data),"newMatch"==t.data)return e.wvwDisabled=!0,e.wvw=null,!1;e.wvwDisabled=!1,e.wvw=t.data.wvw,e.currentMatch=e.wvw.skirmishes.length-1,e.wvw.labels=e.wvwColors.map(e=>t.data.wvw.all_worlds[e].map(e=>c.find(t=>t.id==e).name).join(", ")),e.wvw.skirmishes.forEach(t=>{t.scoreArr=e.wvwColors.map(e=>t.scores[e])}),e.wvw.history=e.wvwColors.map(t=>e.wvw.skirmishes.map(e=>e.scores[t])),e.wvw.histLabels=new Array(e.wvw.history[0].length).fill(100).map((e,t)=>t+1),e.wvw.histColors=[{backgroundColor:"transparent",borderColor:"#f00",pointBackgroundColor:"#f00"},{backgroundColor:"transparent",borderColor:"#0f0",pointBackgroundColor:"#0f0"},{backgroundColor:"transparent",borderColor:"#00f",pointBackgroundColor:"#00f"}],console.log("WVW",e.wvw),e.mapMarkers=[],e.wvwOwned=t.data.owned||null,e.makeMarkers();let a=document.querySelector("#wvw-map");console.log("mapDiv",a,a.offsetWidth),e.doMap(e.wvw.maps)})},e.nextSkirm=()=>{if(!e.wvw)return!1;e.wvw.skirmishes.length>e.currentMatch+1?e.currentMatch++:e.currentMatch=0,e.positionVert()},e.prevSkirm=()=>{if(!e.wvw)return!1;e.currentMatch&&e.currentMatch>0?e.currentMatch--:e.currentMatch=e.wvw.skirmishes.length-1,e.positionVert()},e.lastSkirm=()=>{e.currentMatch=e.wvw.skirmishes.length-1,e.positionVert()},e.firstSkirm=()=>{e.currentMatch=0,e.positionVert()},e.mats=["blood","bone","claw","fang","scale","totem","venom"],e.cores=["glacial","onyx","destroyer","molten","corrupted","essence","crystal","charged"],e.calcPrices=t=>{console.log("DATA before prices",t),t.push({hi:2504,lo:2504,lName:"Bottle of Elonian Wine",id:19663,sName:"wine"});let a=t.find(e=>"t6dust"==e.sName);return e.mats.forEach(e=>{let o=t.find(t=>t.sName=="t5"+e),n=t.find(t=>t.sName=="t6"+e);n.hiProf=12*n.hi-(50*o.lo+1*n.lo+5*a.lo),n.loProf=5*n.lo-(50*o.hi+1*n.hi+5*a.hi),n.t5=o,n.profGood=0,n.hiProf>0&&n.loProf>0?n.profGood=1:n.hiProf<0&&n.loProf<0&&(n.profGood=-1)}),e.cores.forEach(e=>{let o=t.find(t=>t.sName=="c"+e),n=t.find(t=>t.sName=="l"+e);n.c=o,n.hiProf=n.hi-(2*o.lo+a.lo+2504),n.loProf=n.lo-(2*o.hi+a.hi+2504),n.profGood=0,n.hiProf>0&&n.loProf>0?n.profGood=1:n.hiProf<0&&n.loProf<0&&(n.profGood=-1)}),console.log("PRICES!",t),t},e.isMat=e=>e.sName.indexOf("t6")>-1&&"t6dust"!=e.sName,e.isGem=e=>e.sName.indexOf("t6")<0&&"wine"!=e.sName&&e.sName.indexOf("t5")<0&&"l"==e.sName[0],e.histClick=t=>{if(console.log("CLICKED:",t,Chart),!t||!t[0])return!1;e.currentMatch=t[0]._index,e.positionVert()},e.positionVert=()=>{e.lineOpts.title.text=`(${e.currentMatch+1})`},Chart.plugins.register({id:"vert",afterDraw:function(t,a){if("doughnut"!=t.config.type){e.lineXWid=t.chartArea.right-t.chartArea.left,e.lineYWid=t.chartArea.left,e.lineHeight=t.chartArea.bottom-t.chartArea.top,e.lineStepWid=e.lineXWid/(e.wvw.skirmishes.length-1);const a=t.canvas.getContext("2d");a.moveTo(e.lineYWid+e.currentMatch*e.lineStepWid,5),a.lineTo(e.lineYWid+e.currentMatch*e.lineStepWid,e.lineHeight+5),a.strokeStyle="#fff",a.stroke()}}}),e.lineOpts={title:{text:`(${e.currentMatch+1})`},scales:{yAxes:[{ticks:{beginAtZero:!0,fontColor:"#fff"}}],xAxes:[{ticks:{fontColor:"#fff"}}]},hover:{animationDuration:0}},e.refPrices(),e.getMapState=()=>{console.log("ZOOM",e.map.getZoom(),"BOUNDS",e.map.getBounds())},e.unproject=function(e,t){return e.unproject(t,e.getMaxZoom())},e.doMap=function(t){let a,o;e.map=L.map("wvw-map",{minZoom:0,maxZoom:6}),o=e.unproject(e.map,[15700,8900]),a=e.unproject(e.map,[5100,15900]);const n=new L.LatLngBounds(e.unproject(e.map,[16384,0]),e.unproject(e.map,[0,16384]));L.tileLayer("https://tiles.guildwars2.com/2/3/{z}/{x}/{y}.jpg",{subdomains:["tiles1","tiles2","tiles3","tiles4"],bounds:n,minNativeZoom:4,noWrap:!0}).addTo(e.map),e.map.setMaxBounds(new L.LatLngBounds(a,o)),e.map.setView(new L.LatLng((o.lat-a.lat)/2,(o.lng-a.lng)/2),0),t.forEach(t=>{t.objectives.filter(e=>!!e.marker).forEach(t=>{let a=e.mapMarkers.find(e=>e.options.iconName==t.type.toLowerCase()+"-"+t.owner.toLowerCase());console.log("THIS OBJECTIVE",t,"MARKER (probly)",a,"FROM",t.type.toLowerCase()+"-"+t.owner.toLowerCase()),L.marker(e.unproject(e.map,t.coord),{title:`${t.name} (owned by: ${t.owner})`,icon:a}).addTo(e.map)})}),setTimeout((function(){e.map.invalidateSize(),e.map.setZoom(3)}),500)}}]),t.controller("unconf-cont",["$scope","$http","$state",function(e,t,a){e.logout=function(){t.get("/user/logout").then((function(e){console.log(e),a.go("appSimp.login")}))}}]),t.factory("socketFac",["$rootScope",function(e){const t=io.connect();return{on:function(a,o){t.on(a,(function(){const a=arguments;e.$apply((function(){o.apply(t,a)}))}))},emit:function(a,o,n){t.emit(a,o,(function(){const a=arguments;e.$apply((function(){n&&n.apply(t,a)}))}))}}}]),t.run(["$rootScope","$state","$stateParams","$transitions","$q","userFact",function(e,t,a,o,n,r){o.onBefore({to:"app.**"},(function(e){let a=n.defer();return console.log("TRANS",e),e.injector().get("userFact").getUser().then((function(e){console.log("response from login chck",e),e.data&&e.data.confirmed?a.resolve(!0):e.data?a.resolve(t.target("appSimp.unconfirmed",void 0,{location:!0})):a.resolve(t.target("appSimp.login",void 0,{location:!0}))})).catch(e=>{a.resolve(t.target("appSimp.login",void 0,{location:!0}))}),a.promise})),o.onBefore({to:"app.blog"},(function(e){let a=n.defer();return e.injector().get("userFact").getUser().then(e=>{if(!e.data.mod)return console.log("tried to access editor as non-mod!"),a.resolve(t.target("app.dash",void 0,{location:!0}));a.resolve(!0)}),a.promise}))}]),t.factory("userFact",["$http",function(e){return{getUser:function(){return e.get("/user/getUsr").then((function(e){return console.log("getUser in fac says:",e),e}))}}}])}();