...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},socket=io(),app=angular.module("brethren-app",["ui.router","ngAnimate","ngSanitize","chart.js"]),resetApp=angular.module("reset-app",[]),defaultPic="data:image/png;base64,",hadDirect=!(Array.prototype.findUser=function(e){for(var t=0;t<this.length;t++)if(this[t].user==e)return t;return-1}),dcRedirect=["$location","$q","$injector",function(n,a,e){var o="";return{request:function(e){return o=n.path(),e},requestError:function(e){return a.reject(e)},response:function(e){return e},responseError:function(t){console.log("Something bad happened!",t,o,n.path()),hadDirect=!0,bulmabox.alert("App Restarting","Hi! I've made some sort of change just now to make this app more awesome! Unfortunately, this also means I've needed to restart it. I'm gonna log you out now.",function(e){fetch("/user/logout").then(function(e){return hadDirect=!1,$state.go("appSimp.login",{},{reload:!0}),a.reject(t)})})}}}];app.config(["$stateProvider","$urlRouterProvider","$locationProvider","$httpProvider",function(e,t,n,a){n.html5Mode(!0),t.otherwise("/404"),e.state("app",{abstract:!0,templateUrl:"layouts/full.html"}).state("app.dash",{url:"/",templateUrl:"components/dash.html"}).state("app.chat",{url:"/chat",templateUrl:"components/chat.html"}).state("app.calendar",{url:"/calendar",templateUrl:"components/calendar.html"}).state("app.help",{url:"/help",templateUrl:"components/help/help.html"}).state("app.forum",{url:"/forum",templateUrl:"components/forums/forum.html"}).state("app.forumCat",{url:"/forumCat?c",templateUrl:"components/forums/forumCat.html"}).state("app.forumThr",{url:"/forumThr?c&t",templateUrl:"components/forums/forumThr.html"}).state("app.tools",{url:"/tools",templateUrl:"components/tools.html"}).state("appSimp",{abstract:!0,templateUrl:"components/layout/simp.html"}).state("appSimp.login",{url:"/login",templateUrl:"components/login.html"}).state("appSimp.register",{url:"/register",templateUrl:"components/register.html"}).state("appSimp.unconfirmed",{url:"/unconf",templateUrl:"components/alt/unconfirmed.html"}).state("appSimp.notfound",{url:"/404",templateUrl:"components/alt/404.html"}).state("appSimp.err",{url:"/500",templateUrl:"components/alt/500.html"})}]).directive("fileread",[function(){return{scope:{fileread:"="},link:function(o,e,t){e.bind("change",function(e){var t=new FileReader,n=e.target.files[0],a=n.name;return console.log("UPLOADING FILE",n),t.onload=function(e){var t=e.target.result;console.log("URI before optional resize",t,t.length),o.$parent.needsResize?resizeDataUrl(o,t,o.$parent.needsResize,o.$parent.needsResize,a):o.$apply(function(){o.$parent.loadingFile=!1,o.$parent.fileName="Loaded:"+a,o.fileread=t,o.$parent.saveDataURI&&"function"==typeof o.$parent.saveDataURI&&o.$parent.saveDataURI(dataURI)})},n?25e5<n.size?(bulmabox.alert("File too Large","Your file "+n.name+" is larger than 2.5MB. Please upload a smaller file!"),!1):void t.readAsDataURL(n):(o.$apply(function(){o.fileread="",o.$parent.fileName=!1,o.$parent.loadingFile=!1}),!1)})}}}]),Array.prototype.rotate=function(e){for(var t=angular.copy(this),n=0;n<e;n++)t.push(t.shift());return t},Date.prototype.dyMo=function(){return this.getMonth()+1+"/"+this.getDate()},String.prototype.titleCase=function(){return this.split(/\s/).map(function(e){return e.slice(0,1).toUpperCase()+e.slice(1).toLowerCase()}).join(" ")};var resizeDataUrl=function(a,e,o,r,l){var t=document.createElement("img");t.onload=function(){var e=document.createElement("canvas"),t=e.getContext("2d");e.width=o,e.height=r,t.drawImage(this,0,0,o,r);var n=e.toDataURL();a.$apply(function(){a.$parent.loadingFile=!1,a.$parent.fileName="Loaded:"+l,a.fileread=n,a.$parent.saveDataURI&&"function"==typeof a.$parent.saveDataURI&&a.$parent.saveDataURI(n)})},t.src=e};app.factory("socketFac",["$rootScope",function(a){var o=io.connect();return{on:function(e,t){o.on(e,function(){var e=arguments;a.$apply(function(){t.apply(o,e)})})},emit:function(e,t,n){o.emit(e,t,function(){var e=arguments;a.$apply(function(){n&&n.apply(o,e)})})}}}]),app.run(["$rootScope","$state","$stateParams","$transitions","$q","userFact",function(e,n,t,a,o,r){a.onBefore({to:"app.**"},function(e){var t=o.defer();return console.log("TRANS",e),e.injector().get("userFact").getUser().then(function(e){console.log("response from login chck",e),e.data&&e.data.confirmed?t.resolve(!0):e.data?t.resolve(n.target("appSimp.unconfirmed",void 0,{location:!0})):t.resolve(n.target("appSimp.login",void 0,{location:!0}))}).catch(function(e){t.resolve(n.target("appSimp.login",void 0,{location:!0}))}),t.promise})}]),app.factory("userFact",["$http",function(e){return{getUser:function(){return e.get("/user/getUsr").then(function(e){return console.log("getUser in fac says:",e),e})}}}]),app.controller("cal-cont",["$scope","$http",function(l,s){l.cal=[],l.days=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],l.calLoaded=!1,l.refCal=function(){s.get("/cal/all").then(function(e){console.log("calendar events response:",e),l.makeCalendar(e.data)})},l.refCal(),l.makeCalendar=function(e){l.offsetDays=l.days.rotate((new Date).getDay());var t=0,a=0,o=new Date;for(o.setHours(0,0,0,0),o=o.getTime(),l.cal=[];t<6;t++){var r={wk:t,wkSt:new Date(o+7*t*1e3*3600*24),wkEn:new Date(o+1e3*(7*(t+1)-1)*3600*24),days:[]},n=function(){var n=new Date(o+1e3*(7*t+a)*3600*24);r.days.push({d:a,evts:e.filter(function(e){var t=new Date(e.eventDate).getTime();return console.log("THIS DATE DTNUM",t,n.getTime()),t>n.getTime()&&t<n.getTime()+864e5}),date:n})};for(a=0;a<7;a++)n();l.cal.push(r)}console.log("CAL STUFF",l.cal,l.offsetDays)},l.viewEvent=function(e){console.log("View event",e),bulmabox.alert("Event: "+e.title,"Time:"+new Date(e.eventDate).toString()+"<hr>"+e.text)},l.editEvent=function(e){console.log("Edit event",e);for(var t="",n=new Date(e.eventDate),a=0;a<24;a++){var o=a<13?a:a-12,r=a<12?" am":" pm";o&&0!=o||(o=12),t+="<option value ="+a+" "+(n.getHours()==a&&0==n.getMinutes()?"selected":"")+">"+o+":00"+r+"</options><option value ="+(a+.5)+" "+(n.getHours()==a&&30==n.getMinutes()?"selected":"")+">"+o+":30"+r+"</options>"}bulmabox.custom("Edit Event",'<div class="field">\n            \t<label class=\'label\'>\n                Event Title\n                </label>\n                    <p class="control has-icons-left">\n                        <input class="input" type="text" placeholder="A title for your event" id=\'newTitle\' value=\''+e.title+"'>\n                        <span class=\"icon is-small is-left\">\n                            <i class=\"fa fa-puzzle-piece\"></i>\n                        </span>\n                    </p>\n                </div>\n                <div class=\"field\">\n                <label class='label'>\n               Description of Event\n                </label>\n                    <p class=\"control\">\n                        <textarea class='textarea' id='newMsg' placeholder='A description for your event (optional)'>"+e.text+"</textarea>\n                    </p>\n                </div>\n                <div class=\"field\">\n                <label class='label'>\n                When should this event occur?\n                </label>\n                    <p class=\"select\">\n                        <select id='newTime'>\n                        \t"+t+"\n                        </select>\n                    </p>\n                </div>",function(){var e=document.querySelector("#newTitle").value,t=document.querySelector("#newMsg").value,n=new Date;n.setHours(0,0,0,0);var a=3600*parseInt(document.querySelector("#newTime").value)*1e3+n.getTime()+1e3*(7*wk.wk+dy.d)*3600*24;console.log("Sending event",e,t,a),s.post("/cal/new",{title:e,text:t,eventDate:a}).then(function(e){console.log("new event response",e),l.refCal()})},"<button class='button is-info' onclick='bulmabox.runCb(bulmabox.params.cb)'>Add</button><button class='button is-danger' onclick='bulmabox.kill(\"bulmabox-diag\")'>Cancel</button>")},l.delEvent=function(t){console.log("Delete event",t),bulmabox.confirm("Delete Event","Are you sure you wish to delete the following event?<br> Title: "+t.title+"<br>Description: "+t.text,function(e){if(!e||null==e)return!1;s.get("/cal/del?id="+t._id).then(function(e){console.log("delete response",e),l.refCal()})})},l.addEvent=function(o,r){console.log("DAY is",r);for(var e="",t=0;t<24;t++){var n=t<13?t:t-12,a=t<12?" am":" pm";n&&0!=n||(n=12),e+="<option value ="+t+">"+n+":00"+a+"</options><option value ="+(t+.5)+">"+n+":30"+a+"</options>"}bulmabox.custom("Add Event",'<div class="field">\n            \t<label class=\'label\'>\n                Event Title\n                </label>\n                    <p class="control has-icons-left">\n                        <input class="input" type="text" placeholder="A title for your event" id=\'newTitle\'>\n                        <span class="icon is-small is-left">\n                            <i class="fa fa-puzzle-piece"></i>\n                        </span>\n                    </p>\n                </div>\n                <div class="field">\n                <label class=\'label\'>\n               Description of Event\n                </label>\n                    <p class="control">\n                        <textarea class=\'textarea\' id=\'newMsg\' placeholder=\'A description for your event (optional)\'></textarea>\n                    </p>\n                </div>\n                <div class="field">\n                <label class=\'label\'>\n                When should this event occur?\n                </label>\n                    <p class="select">\n                        <select id=\'newTime\'>\n                        \t<option disabled selected>Select a time</option>\n                        \t'+e+"\n                        </select>\n                    </p>\n                </div>",function(){var e=document.querySelector("#newTitle").value,t=document.querySelector("#newMsg").value,n=new Date;n.setHours(0,0,0,0);var a=3600*parseInt(document.querySelector("#newTime").value)*1e3+n.getTime()+1e3*(7*o.wk+r.d)*3600*24;console.log("Sending event",e,t,a),s.post("/cal/new",{title:e,text:t,eventDate:a}).then(function(e){console.log("new event response",e),l.refCal()})},"<button class='button is-info' onclick='bulmabox.runCb(bulmabox.params.cb)'>Add</button><button class='button is-danger' onclick='bulmabox.kill(\"bulmabox-diag\")'>Cancel</button>")}}]),app.controller("chat-cont",["$scope","$http","$state","$filter","$sce",function(t,e,n,a,o){e.get("/user/getUsr").then(function(e){t.doUser(e.data),console.log("user",t.user)}),t.msgs=[],t.doUser=function(e){if(!e)return!1;t.user=e,t.msgs.push({time:Date.now(),user:"System",msg:"Welcome to Brethren [PAIN] Chat! You're logged in as "+e.user+". Try /wiki or /google to search for stuff!",isSys:!0})},t.parseMsg=function(e){return 0===e.indexOf("/wiki ")?'Wiki: <a href="https://wiki.guildwars2.com/wiki/'+e.slice(6)+'" target="_blank">'+e.slice(6)+"</a>":0===e.indexOf("/google ")?'Google: <a href="https://www.google.com/search?q='+e.slice(8)+'" target="_blank">'+e.slice(8)+"</a>":e},e.get("/user/allUsrs").then(function(e){console.log("all users is",e),t.allUsers=e.data}),socket.on("msgOut",function(e){console.log(t.parseMsg(e.msg),"IS THE MESSAGE"),e.msg=o.trustAsHtml(t.parseMsg(e.msg)),t.msgs.push(e),100<t.msgs.length&&t.msgs.shift(),t.$apply(),document.querySelector("#chat-container").scrollTop=document.querySelector("#chat-container").scrollHeight}),socket.on("disconnect",function(){t.msgs.push({time:Date.now(),user:"System",msg:"Warning: The connection to the server was lost. Until you refresh, chat's probably gonna be pretty quiet!",isSys:!0}),100<t.msgs.length&&t.msgs.shift(),t.$apply(),document.querySelector("#chat-container").scrollTop=document.querySelector("#chat-container").scrollHeight}),t.sendChat=function(){if(!t.newMsg)return!1;socket.emit("chatMsg",{user:t.user.user,msg:t.newMsg}),t.newMsg=""}}]),app.controller("dash-cont",["$scope","$http","$state","$filter",function(r,l,e,t){r.showDups=localStorage.brethDups,l.get("/user/getUsr").then(function(e){r.doUser(e.data),console.log("user",r.user)}),l.get("/cal/latestFive").then(function(e){r.latestEvents=e.data}),r.doUser=function(n){if(!n)return!1;r.user=n,console.log(n),r.possibleInterests.forEach(function(e,t){n.ints&&n.ints[t]&&1==n.ints[t]&&(e.active=!0)}),r.numUnreadMsgs=n.msgs.filter(function(e){return!e.read}).length},r.tabs=[{name:"Profile/Characters",icon:"user"},{name:"Members",icon:"users"},{name:"Inbox",icon:"envelope"},{name:"Upcoming Events",icon:"calendar"}],r.defaultPic=defaultPic,r.loadingFile=!1,r.fileName=null,r.needsResize=65,r.loadFile=function(){r.loadingFile=!0;new FileReader},r.saveDataURI=function(e){l.post("/user/changeAva",{img:e}).then(function(e){r.doUser(e.data)})},r.possibleInterests=[{name:"General PvE",warn:!1,active:!1,icon:"pve.png"},{name:"sPvP",warn:!1,active:!1,icon:"pvp.png"},{name:"WvW",warn:!1,active:!1,icon:"wvw.png"},{name:"Fractals",warn:!1,active:!1,icon:"fracs.png"},{name:"Raids",warn:!0,active:!1,icon:"raids.png"},{name:"Role-Playing",warn:!0,active:!1,icon:"rp.png"}],r.tzs=angular.copy(timezoneList),r.changeInterest=function(e,t){console.log(e),e.warn&&e.active&&bulmabox.alert("Game Mode Warning","Hey! Just so you know, Brethren generally doesn't do "+e.name+".<br>However, that doesn't mean we don't have people that might be interested!"),l.get("/user/changeInterest?int="+t+"&act="+e.active).then(function(e){r.doUser(e.data)})},r.changeTz=function(){l.get("/user/changeTz?tz="+r.user.tz).then(function(e){r.doUser(e.data)})},r.otherInfTimer=null,r.setOtherInfTimer=function(){r.otherInfTimer&&clearTimeout(r.otherInfTimer),r.otherInfTimer=setTimeout(function(){l.post("/user/changeOther",{other:r.user.otherInfo}).then(function(e){r.doUser(e.data)})},500)},r.memNameSort=!1,r.charSearch="",r.pickedInts=[!1,!1,!1,!1,!1,!1],r.intSearchToggle=!1,r.charSearchToggle=!1,r.memFilter=function(n){if(r.charSearch&&!hasChars.length)return!1;if(r.pickedInts.filter(function(e){return!!e}).length){var a=!0;if(r.pickedInts.forEach(function(e,t){e&&!n.ints[t]&&(a=!1)}),!a)return!1}return!0},l.get("/user/allUsrs").then(function(e){console.log("all users is",e),r.allUsers=e.data,setTimeout(function(){socket.emit("getOnline",{})},100)}),socket.on("allNames",function(t){t=t.map(function(e){return e.name}),r.allUser&&r.allUsers.forEach(function(e){e.online=-1<t.indexOf(e.user)||e.user==r.user.user}),r.$digest()}),r.showTab=function(e){r.currTab=e},r.currTab="Profile/Characters",r.makeMod=function(t){console.log("wanna mod",t),bulmabox.confirm("Assign Moderator Rights","Warning: This will give user "+t.user+" full moderator rights, and prevents them from being banned. This process is <i>not</i> reversable!",function(e){if(!e||null==e)return!1;l.get("/user/makeMod?user="+t.user).then(function(e){r.allUsers=e.data})})},r.toggleBan=function(e){l.get("/user/toggleBan?user="+e.user).then(function(e){r.allUsers=e.data})},r.confirmUsr=function(t){bulmabox.confirm("Confirm User","Are you sure you wish to confirm user "+t.user+"?",function(e){e&&null!=e&&l.get("/user/confirm?u="+t.user).then(function(e){r.allUsers=e.data})})},r.races=["Asura","Charr","Human","Norn","Sylvari"],r.profs=["Guardian","Warrior","Revenant","Thief","Ranger","Engineer","Elementalist","Mesmer","Necromancer"],r.addChar=function(){var e=r.races.map(function(e){return"<label class='char-opt opt-"+e+"'><input type='radio' name='char-race' value="+e+" title="+e+"><div></div></label>"}).join(""),t=r.profs.map(function(e){return"<label class='char-opt opt-"+e+"'><input type='radio' name='char-prof' value="+e+" title="+e+"><div></div></label>"}).join("");bulmabox.custom("Add a character",'<div class="field">\n    <label class="label">\n        Name\n    </label>\n    <p class="control has-icons-left">\n        <input class="input" type="text" placeholder="Your character\'s name" id=\'char-name\'>\n        <span class="icon is-small is-left">\n            <i class="fa fa-user"></i>\n        </span>\n    </p>\n</div>\n<div class="field">\n    <label class=\'label\'>\n        Race\n    </label>\n    '+e+"\n</div>\n<div class=\"field\">\n    <label class='label'>\n        Profession\n    </label>\n    "+t+"\n</div>\n<div class=\"field\">\n    <label class='label'>\n        Level\n    </label>\n    <p class=\"control\">\n        <input class='input' type='number' id='char-lvl' min='1' max='80' value='80'>\n    </p>\n</div>\n<div class=\"field\">\n    <label class='label'>\n        Other Info\n    </label>\n    <p class=\"control\">\n        <textarea class='textarea' id='char-other' placeholder='Any other information you wanna include (optional)'></textarea>\n    </p>\n</div>",function(){var e=document.querySelector("input[name=char-prof]:checked"),t=document.querySelector("input[name=char-race]:checked"),n=document.querySelector("#char-name");if(!e||!t||!n)return bulmabox.alert("Needs More Info","You need to specify a profession, race, and name! Otherwise we won't know who/what you are!"),!1;var a={name:document.querySelector("#char-name").value,prof:document.querySelector("input[name=char-prof]:checked").value,race:document.querySelector("input[name=char-race]:checked").value,lvl:document.querySelector("#char-lvl").value,other:document.querySelector("#char-other").value};console.log("User wants to add char",a),l.post("/user/addChar",a).then(function(e){r.doUser(e.data)})},"<button class='button is-info' onclick='bulmabox.runCb(bulmabox.params.cb)'>Save</button><button class='button is-danger' onclick='bulmabox.kill(\"bulmabox-diag\")'>Cancel</button>")},r.autoChars=function(){bulmabox.prompt("Auto-Fill Characters from API","Auto-filling characters from the Guild Wars 2 Official API will replace any existing characters you've entered with API-found characters. <br><br> - You'll need an API key to do this (click <a href='https://account.arena.net/' target='_blank'>here</a> if you dont have one). <br><br>Are you sure you wish to do this?",function(e){e&&null!=e&&l.get("/user/charsFromAPI?api="+e).then(function(e){console.log("Auto-char response is",e),e&&e.data&&"err"!=e.data?r.doUser(e.data):bulmabox.alert("Error Auto-Filling","There was an error auto-filling your characters.<br>While it <i>may</i> be Dave's fault, you may also wanna check that your API key is valid. You can also always just manually add your characters!")})})},r.delChr=function(t){console.log("user wishes to remove character",t),bulmabox.confirm("Remove Character","Are you sure you wish to remove the character "+t.name+"?",function(e){e&&null!=e&&l.get("/user/remChar?id="+t._id).then(function(e){r.doUser(e.data)}).catch(function(e){bulmabox.alert("Error","There was a problem removing this character!")})})},r.editChar=function(t){console.log("usr wants to",t,Date.now());var e=r.races.map(function(e){return"<label class='char-opt opt-"+e+"'><input type='radio' name='char-race' value="+e+" title="+e+" "+(e==t.race?"checked":"")+"><div></div></label>"}).join(""),n=r.profs.map(function(e){return"<label class='char-opt opt-"+e+"'><input type='radio' name='char-prof' value="+e+" title="+e+" "+(e==t.prof?"checked":"")+"><div></div></label>"}).join("");bulmabox.custom("Edit character",'<div class="field">\n    <label class="label">\n        Name\n    </label>\n    <p class="control has-icons-left">\n        <input class="input" type="text" placeholder="Your character\'s name" id=\'char-name\' value=\''+t.name+'\'>\n        <span class="icon is-small is-left">\n            <i class="fa fa-user"></i>\n        </span>\n    </p>\n</div>\n<div class="field">\n    <label class=\'label\'>\n        Race\n    </label>\n    '+e+"\n</div>\n<div class=\"field\">\n    <label class='label'>\n        Profession\n    </label>\n    "+n+"\n</div>\n<div class=\"field\">\n    <label class='label'>\n        Level\n    </label>\n    <p class=\"control has-icons-left\">\n        <input class='input' type='number' id='char-lvl' min='1' max='"+t.lvl+"' value='80'>\n        <span class=\"icon is-small is-left\">\n            <i class=\"fa fa-signal\"></i>\n        </span>\n    </p>\n</div>\n<div class=\"field\">\n    <label class='label'>\n        Other Info\n    </label>\n    <p class=\"control\">\n        <textarea class='textarea' id='char-other' placeholder='Any other information you wanna include (optional)'>"+t.other+"</textarea>\n    </p>\n</div>",function(e){var t=document.querySelector("input[name=char-prof]:checked"),n=document.querySelector("input[name=char-race]:checked"),a=document.querySelector("#char-name");if(!t||!n||!a)return bulmabox.alert("Needs More Info","You need to specify a profession, race, and name! Otherwise we won't know who/what you are!"),!1;var o={name:document.querySelector("#char-name").value,prof:document.querySelector("input[name=char-prof]:checked").value,race:document.querySelector("input[name=char-race]:checked").value,lvl:document.querySelector("#char-lvl").value,other:document.querySelector("#char-other").value};console.log("User wants to add char",o,e),l.post("/user/editChar",o).then(function(e){r.doUser(e.data)})},"<button class='button is-info' onclick='bulmabox.runCb(bulmabox.params.cb)'>Save</button><button class='button is-danger' onclick='bulmabox.kill(\"bulmabox-diag\")'>Cancel</button>")},r.mail=function(n){bulmabox.custom("Send Message","<div class=\"field\">\n    <label class='label'>\n        Message\n    </label>\n    <p class=\"control\">\n        <textarea class='textarea' id='newMsg' placeholder='What do you wanna say?'></textarea>\n    </p>\n</div>",function(e){var t=document.querySelector("#newMsg").value;if(!t)return bulmabox.alert("Huh?","Sorry, but we don't support uncomfortable silences currently."),!1;l.post("/user/sendMsg",{msg:t,to:n.user}).then(function(e){})},"<button class='button is-info' onclick='bulmabox.runCb(bulmabox.params.cb)'>Send</button><button class='button is-danger' onclick='bulmabox.kill(\"bulmabox-diag\")'>Cancel</button>")},r.viewMsg=function(e){bulmabox.alert("Message from "+e.from,e.msg||"(No message)"),l.get("/user/setOneRead?id="+e._id).then(function(e){r.doUser(e.data)})},r.delMsg=function(t){console.log("user wishes to delete msg",t),bulmabox.confirm("Delete Message","Are you sure you wish to delete this message?",function(e){console.log("resp",e),e&&null!=e&&l.get("/user/delMsg?id="+t._id).then(function(e){r.doUser(e.data)})})},r.repMsg=function(t){console.log("user wishes to report msg",t),bulmabox.confirm("Report Message","Reporting a message sends a notification to the moderators, including the details of the message.<br>It will then be up to the moderators to determine if you're being uncool to each other.<br>Are you sure you wish to report this message?",function(e){console.log("resp",e),l.post("/user/repMsg",t).then(function(e){"dupRep"==e.data&&bootbox.alert("Already Reported","You've already reported this message. Please wait while the moderator team reviews your report.")})})},r.viewEvent=function(e){bulmabox.alert("Event: "+e.title,"Date:"+t("numToDate")(e.eventDate)+"<br>Description:"+e.text)}}]).filter("numToDate",function(){return function(e){if(isNaN(e))return"Invalid date!";var t=new Date(e);return console.log(t.getMinutes()),t.toLocaleDateString()+" "+t.getHours()%12+":"+(t.getMinutes().toString().length<2?"0"+t.getMinutes():t.getMinutes())+" "+(t.getHours()<13?"AM":"PM")}}),app.controller("forum-cat-cont",["$scope","$http","$state","$location",function(n,a,t,e){localStorage.brethUsr||t.go("app.login"),a.get("/user/getUsr").then(function(e){n.user=e.data,console.log("user",n.user)}),n.newThr={},n.fileName=null,n.currCat=e.search().c,n.refCat=function(){a.get("/forum/byCat?grp="+n.currCat).then(function(e){console.log("thrds in this cat",e),n.threads=e.data.sort(function(e,t){return e.stickied===t.stickied?e.lastUpd-t.lastUpd:e.stickied?-1:1})})},n.refCat(),n.newThrDial=function(){n.makingThread=!0},n.clearThread=function(){n.newThr={},n.makingThread=!1,n.loadingFile=!1},n.loadFile=function(){n.loadingFile=!0;new FileReader},n.makeThread=function(){n.newThr.md=n.newThr.txt,n.newThr.text=(new showdown.Converter).makeHtml(n.newThr.txt),n.newThr.grp=n.currCat,a.post("/forum/newThread",n.newThr).then(function(e){console.log("new thred response",e),t.go(t.current,{},{reload:!0})})},n.toggleSticky=function(e,t){e.stopPropagation(),e.preventDefault(),a.get("/forum/toggleSticky?id="+t).then(function(e){console.log("response from thread sticky toggle is",e),n.refCat()})},n.toggleLock=function(e,t){e.stopPropagation(),e.preventDefault(),a.get("/forum/toggleLock?id="+t).then(function(e){console.log("response from thread lock toggle is",e),n.refCat()})}}]),app.controller("forum-cont",["$scope","$http","$state","$sce",function(n,e,t,a){n.currMsg=0,n.forObj={},localStorage.brethUsr||t.go("app.login"),e.get("/forum/cats").then(function(t){var e=Object.keys(t.data);n.forObj=e.map(function(e){return{name:e,count:t.data[e].n,time:0<t.data[e]?new Date(t.data[e]):null}})}),n.searchin=!1,n.search="",n.searchTimer=null,n.doSearch=function(){n.searchTimer&&clearTimeout(n.searchTimer),n.searchTimer=setTimeout(function(){n.search&&n.search.length&&e.post("/forum/searchThr",{term:n.search}).then(function(e){console.log("search response",e),n.searchResults=e.data})},500)},n.goCat=function(e){t.go("app.forumCat",{c:e})}}]),app.controller("forum-thr-cont",["$scope","$http","$state","$location","$sce",function(a,n,e,t,o){a.currMsg=0,a.defaultPic=defaultPic,a.forObj={},a.fileName=null,localStorage.brethUsr||e.go("app.login"),a.loadingFile=!1,a.loadFile=function(){a.loadingFile=!0;new FileReader},a.currCat=t.search().c,a.id=t.search().t,a.refThred=function(){console.log("info to back:",a.id),n.get("/forum/thread?id="+a.id).then(function(n){console.log("response",n),a.thr=n.data.thrd,n.data.psts.map(function(e){return e.rawText=e.text,e.text=o.trustAsHtml(e.text),e.date=new Date(e.lastUpd).toLocaleString(),e.wasEdited=e.lastUpd!=e.createDate,e}),a.avas=n.data.ava,a.thr.posts=a.thr.posts.map(function(t){console.log("PSTH",t,n.data.psts.filter(function(e){return e._id==t.id})[0]);var e=n.data.psts.filter(function(e){return e._id==t.id})[0];return e.votesUp=t.votesUp,e.votesDown=t.votesDown,e.order=t.order,n.data.psts.filter(function(e){return e._id==t.id})[0]}).sort(function(e,t){return e.order-t.order}),console.log("thred response",a.thr,n)})},a.refThred(),n.get("/user/getUsr").then(function(e){a.user=e.data,console.log("user",a.user)}),a.newPost=function(){var e=document.querySelector("#postTxt").value;n.post("/forum/newPost",{thread:a.thr._id,text:(new showdown.Converter).makeHtml(e),md:e,file:a.file||null}).then(function(e){window.location.reload()})},a.vote=function(e,t){console.log("voting for",e,"direction",t,"which is",void 0===t?"undefined":_typeof(t)),n.post("/forum/vote",{thread:e.thread,post:e._id,voteUp:!!t}).then(function(e){console.log("vote response is:",e),a.refThred()})},a.quoteMe=function(e){document.querySelector("#postTxt").value=">"+e.md}}]),app.controller("inbox-cont",["$scope","$http","userFact",function(t,n,e){t.currMsg=0,console.log("PARENT USER IS:",t.$parent.user),t.chMsg=function(e){e&&t.currMsg<t.$parent.user.msgs.length-1?(console.log("goin up 1 msg"),t.currMsg++):!e&&0<t.currMsg&&t.currMsg--,t.$digest()},t.interpDate=function(e){return new Date(e).toUTCString()},t.reply=function(){e.writeMsg(t.$parent.user.msgs[t.currMsg].from,t.$parent.user.name,!0)},t.deleteMsg=function(){bootbox.confirm("Are you sure you wish to delete this message? Deleted messages are <i>not</i> recoverable!",function(e){e&&null!=e&&n.post("/user/delMsg",{user:t.$parent.user.name,id:t.$parent.user.msgs[t.currMsg].id}).then(function(e){e.data&&e.data.name?(t.$parent.user=e.data,console.log("affected user",t.$parent.user),angular.element("body").scope().$digest(),t.currMsgs=Math.min(t.$parent.user.msgs.length-1,t.currMsgs)):"err"==e.data&&bootbox.alert("Error deleting message!")})})}}]),app.controller("log-cont",["$scope","$http","$state","$q","userFact",function(t,n,a,e,o){t.noWarn=!1,t.nameOkay=!0,delete localStorage.brethUsr,t.checkTimer=!1,t.goReg=function(){a.go("appSimp.register")},t.goLog=function(){a.go("appSimp.login")},t.forgot=function(){t.user?n.post("/user/forgot",{user:t.user}).then(function(e){console.log("forgot route response",e),bootbox.alert("Check your email! If your username is registered, you should recieve an email from us with a password reset link.")}):bootbox.alert("To recieve a password reset email, please enter your username!")},t.signin=function(){n.post("/user/login",{user:t.user,pass:t.pwd}).then(function(e){console.log(e),e.data?(socket.emit("chatMsg",{msg:t.user+" logged in!"}),localStorage.brethUsr=JSON.stringify(e.data),a.go("app.dash")):bulmabox.alert("Incorrect Login","Either your username or password (or both!) are incorrect")}).catch(function(e){bulmabox.alert("Banned","You've been banned! We're a pretty laid-back guild, so you must have <i>really</i> done something to piss us off!"),console.log(e)})},t.checkUser=function(){t.checkTimer&&clearTimeout(t.checkTimer),t.checkTimer=setTimeout(function(){n.get("/user/nameOkay?name="+t.user).then(function(e){t.nameOkay=e.data})},500)},t.register=function(){t.pwd&&t.pwdDup&&t.user?t.pwd!=t.pwdDup?(console.log("derp"),bulmabox.alert("Password Mismatch","Your passwords don't match, or are missing!")):n.post("/user/new",{user:t.user,pass:t.pwd}).then(function(e){n.post("/user/login",{user:t.user,pass:t.pwd}).then(function(){a.go("app.dash")})}):bulmabox.alert("Missing Information","Please enter a username, and a password (twice).")}}]),String.prototype.capMe=function(){return this.slice(0,1).toUpperCase()+this.slice(1)},app.controller("main-cont",["$scope","$http","$state","userFact",function(t,e,n,a){console.log("main controller registered!"),t.user=null,a.getUser().then(function(e){t.user=e.data,socket.emit("hiIm",{name:t.user.user})}),socket.on("reqHeartBeat",function(e){socket.emit("hbResp",{name:t.user.user})})}]),app.controller("nav-cont",["$scope","$http","$state",function(e,t,n){e.logout=function(){bulmabox.confirm("Logout","Are you sure you wish to logout?",function(e){if(!e||null==e)return!0;t.get("/user/logout").then(function(e){n.go("appSimp.login")})})},e.mobActive=!1}]),resetApp.controller("reset-contr",["$scope","$http",function(t,e){t.key=window.location.href.slice(window.location.href.lastIndexOf("/")+1),e.get("/user/resetUsr/"+t.key).then(function(e){t.user=e.data}),t.doReset=function(){t.user&&t.pwd&&t.pwdDup&&t.pwdDup==t.pwd&&t.key?e.post("/user/resetPwd",{acct:t.user.name,pwd:t.pwd,key:t.key}).then(function(e){"err"==e.data?bootbox.alert("There was an error resetting your password."):window.location.href="../../login"}):bootbox.alert("Error: Missing data. Make sure you&rsquo;ve reached this page from a password reset link, and that you have entered the same password in both fields!")}}]);var timezoneList=[{value:-12,text:"(GMT -12:00) Eniwetok, Kwajalein"},{value:-11,text:"(GMT -11:00) Midway Island, Samoa"},{value:-10,text:"(GMT -10:00) Hawaii"},{value:-9,text:"(GMT -9:00) Alaska"},{value:-8,text:"(GMT -8:00) Pacific Time (US & Canada)"},{value:-7,text:"(GMT -7:00) Mountain Time (US & Canada)"},{value:-6,text:"(GMT -6:00) Central Time (US & Canada), Mexico City"},{value:-5,text:"(GMT -5:00) Eastern Time (US & Canada), Bogota, Lima"},{value:-4,text:"(GMT -4:00) Atlantic Time (Canada), Caracas, La Paz"},{value:-3.5,text:"(GMT -3:30) Newfoundland"},{value:-3,text:"(GMT -3:00) Brazil, Buenos Aires, Georgetown"},{value:-2,text:"(GMT -2:00) Mid-Atlantic"},{value:-1,text:"(GMT -1:00) Azores, Cape Verde Islands"},{value:0,text:"(GMT) Western Europe Time, London, Lisbon, Casablanca"},{value:1,text:"(GMT +1:00) Brussels, Copenhagen, Madrid, Paris"},{value:2,text:"(GMT +2:00) Kaliningrad, South Africa"},{value:3,text:"(GMT +3:00) Baghdad, Riyadh, Moscow, St. Petersburg"},{value:3.5,text:"(GMT +3:30) Tehran"},{value:4,text:"(GMT +4:00) Abu Dhabi, Muscat, Baku, Tbilisi"},{value:4.5,text:"(GMT +4:30) Kabul"},{value:5,text:"(GMT +5:00) Ekaterinburg, Islamabad, Karachi, Tashkent"},{value:5.5,text:"(GMT +5:30) Bombay, Calcutta, Madras, New Delhi"},{value:5.75,text:"(GMT +5:45) Kathmandu"},{value:6,text:"(GMT +6:00) Almaty, Dhaka, Colombo"},{value:7,text:"(GMT +7:00) Bangkok, Hanoi, Jakarta"},{value:8,text:"(GMT +8:00) Beijing, Perth, Singapore, Hong Kong"},{value:9,text:"(GMT +9:00) Tokyo, Seoul, Osaka, Sapporo, Yakutsk"},{value:9.5,text:"(GMT +9:30) Adelaide, Darwin"},{value:10,text:"(GMT +10:00) Eastern Australia, Guam, Vladivostok"},{value:11,text:"(GMT +11:00) Magadan, Solomon Islands, New Caledonia"},{value:12,text:"(GMT +12:00) Auckland, Wellington, Fiji, Kamchatka"}],worlds=[{id:1001,name:"Anvil Rock",population:"High"},{id:1002,name:"Borlis Pass",population:"Medium"},{id:1003,name:"Yak's Bend",population:"High"},{id:1004,name:"Henge of Denravi",population:"Medium"},{id:1005,name:"Maguuma",population:"High"},{id:1006,name:"Sorrow's Furnace",population:"Medium"},{id:1007,name:"Gate of Madness",population:"Medium"},{id:1008,name:"Jade Quarry",population:"Medium"},{id:1009,name:"Fort Aspenwood",population:"Full"},{id:1010,name:"Ehmry Bay",population:"Medium"},{id:1011,name:"Stormbluff Isle",population:"Medium"},{id:1012,name:"Darkhaven",population:"Medium"},{id:1013,name:"Sanctum of Rall",population:"VeryHigh"},{id:1014,name:"Crystal Desert",population:"Medium"},{id:1015,name:"Isle of Janthir",population:"Medium"},{id:1016,name:"Sea of Sorrows",population:"VeryHigh"},{id:1017,name:"Tarnished Coast",population:"High"},{id:1018,name:"Northern Shiverpeaks",population:"High"},{id:1019,name:"Blackgate",population:"Full"},{id:1020,name:"Ferguson's Crossing",population:"Medium"},{id:1021,name:"Dragonbrand",population:"Medium"},{id:1022,name:"Kaineng",population:"High"},{id:1023,name:"Devona's Rest",population:"Medium"},{id:1024,name:"Eredon Terrace",population:"Medium"},{id:2001,name:"Fissure of Woe",population:"Medium"},{id:2002,name:"Desolation",population:"VeryHigh"},{id:2003,name:"Gandara",population:"High"},{id:2004,name:"Blacktide",population:"Medium"},{id:2005,name:"Ring of Fire",population:"Medium"},{id:2006,name:"Underworld",population:"Medium"},{id:2007,name:"Far Shiverpeaks",population:"Medium"},{id:2008,name:"Whiteside Ridge",population:"High"},{id:2009,name:"Ruins of Surmia",population:"Medium"},{id:2010,name:"Seafarer's Rest",population:"VeryHigh"},{id:2011,name:"Vabbi",population:"High"},{id:2012,name:"Piken Square",population:"VeryHigh"},{id:2013,name:"Aurora Glade",population:"High"},{id:2014,name:"Gunnar's Hold",population:"Medium"},{id:2101,name:"Jade Sea",population:"High"},{id:2102,name:"Fort Ranik",population:"Medium"},{id:2103,name:"Augury Rock",population:"High"},{id:2104,name:"Vizunah Square",population:"Medium"},{id:2105,name:"Arborstone",population:"Medium"},{id:2201,name:"Kodash",population:"High"},{id:2202,name:"Riverside",population:"Full"},{id:2203,name:"Elona Reach",population:"VeryHigh"},{id:2204,name:"Abaddon's Mouth",population:"Medium"},{id:2205,name:"Drakkar Lake",population:"High"},{id:2206,name:"Miller's Sound",population:"Medium"},{id:2207,name:"Dzagonur",population:"Medium"},{id:2301,name:"Baruch Bay",population:"VeryHigh"}];app.controller("tool-cont",["$scope","$http","$state","$filter","$sce",function(n,t,e,a,o){n.showTab=function(e){n.currTab=e},n.currTab="Dailies",n.tabs=[{name:"Dailies",icon:"calendar-check-o"},{name:"WvW Matchups",icon:"fort-awesome"},{name:"Core/Lodestone Upgrade",icon:"diamond"},{name:"Tier Six Material Conversion",icon:"money"}],n.dailyRestrict={},n.regetDaily=function(){var e=Object.keys(n.dailyRestrict).filter(function(e){return n.dailyRestrict[e]});t.get("/tool/daily"+(e.length?"?modes="+e.join(","):"")).then(function(e){n.dailies=e.data})},n.regetDaily(),n.refPrices=function(){t.get("/tool/allPrices").then(function(e){n.prices=e.data})},n.wvwWorld=!1,n.wvwColors=["red","green","blue"],n.wvwPie={cutoutPercentage:0,backgroundColor:["#aa0000","#00aa00","#0000aa"]},n.refWvw=function(){t.get("/tool/wvw"+(n.wvwWorld?"?world="+n.wvwWorld:"")).then(function(t){console.log("WVW STUFF",t,t.data.data.scores),n.wvw=t.data.data;var e=n.wvwColors.map(function(e){return t.data.data.all_worlds[e].map(function(t){return worlds.find(function(e){return e.id==t}).name}).join(", ")});console.log(e),n.currSkirm={s:n.wvwColors.map(function(e){return t.data.data.scores[e]}),l:e,v:n.wvwColors.map(function(e){return t.data.data.victory_points[e]})}})},n.refPrices(),n.refWvw()}]),app.controller("unconf-cont",["$scope","$http","$state",function(e,t,n){e.logout=function(){t.get("/user/logout").then(function(e){console.log(e),n.go("appSimp.login")})}}]);